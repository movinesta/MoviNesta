  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="Assignments">
        {!isSearching ? (
          <EmptyState title="Search for a user" body="Enter a UUID or email to inspect experiment assignments." />
        ) : rows.length ? (
          <Table>
            <thead>
              <tr>
          ...
          <EmptyState title="No assignments" body="No assignments were found for this user yet." />
        )}
      </Card>
    </div>
  );
