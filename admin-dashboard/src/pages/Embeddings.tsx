      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card title="Active embedding profile">
          ...
          <div className="mt-4">
            ...
            {mutProfile.isError ? <ErrorBox error={mutProfile.error} className="mt-2" /> : null}
          </div>
        ...
        <Card title="Rerank settings (Voyage rerank-2.5)">
          <div className="space-y-3">
            ...
            {mutRerank.isError ? <ErrorBox error={mutRerank.error} className="mt-2" /> : null}
          </div>
        </Card>
      </div>
            ...
            {(q.data?.coverage?.length ?? 0) ? (
              ...
              <tr>
                <Td colSpan={3} className="p-6">
                  <EmptyState title="No coverage" message="No embedding coverage rows were returned." className="border-0 bg-transparent p-0" />
                </Td>
              </tr>
            )}
          </tbody>
