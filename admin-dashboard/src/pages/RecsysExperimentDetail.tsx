  ...
  if (!experiment) {
    return (
      <div className="space-y-4">
        ...
        <EmptyState title="Missing experiment" message="We could not locate this experiment key." />
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <Card title="Variant performance (like rate)">
        ...
        {rows.length ? (
          ...
          <EmptyState title="No metrics yet" message="Impressions with experiment tags will appear here." />
        )}
      </Card>
    </div>
  );
