...
const payloadsByFunction = new Map([
  ...
  ["onboarding-initial-likes", { sessionId: "00000000-0000-0000-0000-000000000000", mediaItemIds: ["00000000-0000-0000-0000-000000000000"], source: "ci" }],
  ...
  ["update-notification-prefs", { emailActivity: false, emailRecommendations: false, inAppSocial: true, inAppSystem: true }],
