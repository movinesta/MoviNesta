...
2) Export outcomes to JSONL (if you haven't):

```bash
node scripts/recsys/export_interactions.mjs --table rec_outcomes --out rec_outcomes.jsonl
```
...
# outputs: ./tmp/rec_impressions.jsonl and ./tmp/rec_outcomes.jsonl
```
