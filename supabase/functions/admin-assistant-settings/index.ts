...
const ParamsSchema = z
  .preprocess((val) => {
    ...
    native_tool_calling: z.boolean().nullable().optional(),
    native_tool_max_loops: z.number().int().min(1).max(12).nullable().optional(),
    native_tool_max_calls_per_loop: z.number().int().min(1).max(20).nullable().optional(),
    parallel_tool_calls: z.boolean().nullable().optional(),
    stream: z.boolean().nullable().optional(),
    stream_passthrough: z.boolean().nullable().optional(),
    ...
    response_healing: z.boolean().nullable().optional(),
    web_search: z.boolean().nullable().optional(),
    web_search_mode: z.string().nullable().optional(),
    web_max_results: z.number().int().min(1).max(10).nullable().optional(),
    web_engine: z.string().nullable().optional(),
    web_search_prompt: z.string().nullable().optional(),
