...
type UrlCitation = { url: string; title?: string; domain?: string };

function extractUrlCitations(raw: any): UrlCitation[] {
  try {
...
function appendUrlCitations(text: string, citations: UrlCitation[]): string {
...
function mergeUiCitations(ui: any, citations: UrlCitation[]): any {
