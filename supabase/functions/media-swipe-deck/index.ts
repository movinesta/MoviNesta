...
// This endpoint is frequently hit during swipe sessions; throttle to protect
    // DB/third-party rerank costs.
    const rl = await enforceRateLimit(req, { action: "swipe_deck", maxPerMinute: 120 });
    if (!rl.ok) {
