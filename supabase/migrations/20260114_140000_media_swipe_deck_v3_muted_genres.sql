-- 20260114_140000_media_swipe_deck_v3_muted_genres.sql
--
-- Session 11: enforce muted genres inside DB RPC (source-side filtering)
--
-- This reduces wasted work in the Edge Function and prevents recommending content from genres the user muted.
...
ALTER FUNCTION public.media_swipe_deck_v3_core(uuid, integer, text, text, text) OWNER TO postgres;
