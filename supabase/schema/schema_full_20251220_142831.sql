...
\restrict i5UCautRzRyXLQ88GlpmvVeaadpbUqtr23GGLQE5rYuSXAiKYafDaTZ8xgsBKiq

-- Dumped from database version 17.6
-- Dumped by pg_dump version 17.7

-- Started on 2025-12-20 14:28:34
...
--
-- TOC entry 43 (class 2615 OID 16542)
...
--
-- TOC entry 110 (class 2615 OID 20106)
...
--
-- TOC entry 145 (class 2615 OID 16653)
...
--
-- TOC entry 1492 (class 1247 OID 16784)
...
--
-- TOC entry 1516 (class 1247 OID 16925)
...
--
-- TOC entry 1489 (class 1247 OID 16778)
...
--
-- TOC entry 1486 (class 1247 OID 16773)
...
--
-- TOC entry 1534 (class 1247 OID 17028)
...
--
-- TOC entry 1546 (class 1247 OID 17101)
...
--
-- TOC entry 1528 (class 1247 OID 17006)
...
--
-- TOC entry 1537 (class 1247 OID 17038)
...
--
-- TOC entry 1522 (class 1247 OID 16967)
...
--
-- TOC entry 1743 (class 1247 OID 23280)
...
--
-- TOC entry 1732 (class 1247 OID 32547)
...
--
-- TOC entry 1749 (class 1247 OID 23310)
...
--
-- TOC entry 1740 (class 1247 OID 23270)
...
--
-- TOC entry 1817 (class 1247 OID 146850)
...
--
-- TOC entry 1774 (class 1247 OID 135403)
...
--
-- TOC entry 1609 (class 1247 OID 17532)
...
--
-- TOC entry 1746 (class 1247 OID 23302)
...
--
-- TOC entry 1752 (class 1247 OID 23318)
...
--
-- TOC entry 1603 (class 1247 OID 17518)
...
--
-- TOC entry 1755 (class 1247 OID 23326)
...
--
-- TOC entry 1612 (class 1247 OID 17546)
...
--
-- TOC entry 1591 (class 1247 OID 17488)
...
--
-- TOC entry 1606 (class 1247 OID 17524)
...
--
-- TOC entry 1597 (class 1247 OID 17498)
...
--
-- TOC entry 1561 (class 1247 OID 17175)
...
--
-- TOC entry 1552 (class 1247 OID 17122)
...
--
-- TOC entry 1555 (class 1247 OID 17137)
...
--
-- TOC entry 1588 (class 1247 OID 17394)
...
--
-- TOC entry 1564 (class 1247 OID 17203)
...
--
-- TOC entry 1576 (class 1247 OID 17301)
...
--
-- TOC entry 600 (class 1255 OID 16540)
...
--
-- TOC entry 612 (class 1255 OID 16755)
...
--
-- TOC entry 494 (class 1255 OID 16539)
...
--
-- TOC entry 533 (class 1255 OID 16538)
...
--
-- TOC entry 699 (class 1255 OID 16597)
...
--
-- TOC entry 582 (class 1255 OID 16599)
...
--
-- TOC entry 483 (class 1255 OID 16609)
...
--
-- TOC entry 731 (class 1255 OID 16610)
...
--
-- TOC entry 603 (class 1255 OID 16387)
...
--
-- TOC entry 812 (class 1255 OID 285130)
...
--
-- TOC entry 735 (class 1255 OID 293492)
...
--
-- TOC entry 545 (class 1255 OID 291046)
...
--
-- TOC entry 649 (class 1255 OID 290511)
...
--
-- TOC entry 528 (class 1255 OID 287153)
...
--
-- TOC entry 756 (class 1255 OID 287163)
...
--
-- TOC entry 632 (class 1255 OID 290510)
...
--
-- TOC entry 578 (class 1255 OID 150338)
...
declare
  d date;
  et text;
  inserted_user_row integer := 0;
begin
  d := coalesce(NEW.event_day, (NEW.created_at at time zone 'utc')::date, (now() at time zone 'utc')::date);
  et := NEW.event_type::text;

  insert into public.media_item_daily (day, media_item_id)
  values (d, NEW.media_item_id)
  on conflict (day, media_item_id) do nothing;

  insert into public.media_item_daily_users (day, media_item_id, user_id)
  values (d, NEW.media_item_id, NEW.user_id)
  on conflict do nothing;

  get diagnostics inserted_user_row = row_count;

  update public.media_item_daily r
  set
    impressions = impressions + case when et = 'impression' then 1 else 0 end,
    dwell_events = dwell_events + case when et = 'dwell' then 1 else 0 end,
    dwell_ms_sum = dwell_ms_sum + case when et = 'dwell' and NEW.dwell_ms is not null then NEW.dwell_ms else 0 end,

    likes = likes + case when et = 'like' then 1 else 0 end,
    dislikes = dislikes + case when et = 'dislike' then 1 else 0 end,
    skips = skips + case when et = 'skip' then 1 else 0 end,

    watchlist_events = watchlist_events + case when et = 'watchlist' then 1 else 0 end,
    rating_events = rating_events + case when et = 'rating' then 1 else 0 end,

    unique_users = unique_users + case when inserted_user_row = 1 then 1 else 0 end,
    updated_at = now()
  where r.day = d
    and r.media_item_id = NEW.media_item_id;
...
--
-- TOC entry 724 (class 1255 OID 149939)
...
declare
  ...
  -- preference half-life (hours). 336h = 14 days.
  half_life_hours double precision := 336;

  dt_hours double precision;
  decay double precision;

  pos_inc double precision := 0;
  neg_inc double precision := 0;
  dwell_norm double precision := 0;

  fb public.media_feedback%rowtype;
begin
  et := NEW.event_type::text;

  -- Ensure feedback row exists
  insert into public.media_feedback (
    user_id,
    media_item_id,
    last_action,
    last_action_at,
  ...
  -- Lock row for update & read previous values
  select *
    into fb
  ...
  dt_hours := extract(epoch from (now_ts - coalesce(fb.updated_at, now_ts))) / 3600.0;
  if dt_hours < 0 then dt_hours := 0; end if;

  decay := exp(-ln(2) * (dt_hours / half_life_hours));

  -- Base increments by event type
  if et = 'like' then pos_inc := 1.0; end if;
  if et = 'dislike' then neg_inc := 1.0; end if;
  if et = 'skip' then neg_inc := greatest(neg_inc, 0.30); end if;

  -- Rating: becomes a positive signal (0..1)
  if NEW.rating_0_10 is not null then
    pos_inc := greatest(
      pos_inc,
      least(1.0, greatest(0.0, NEW.rating_0_10::double precision / 10.0))
    );
  end if;

  -- Watchlist: moderate positive
  if NEW.in_watchlist is true then
    pos_inc := greatest(pos_inc, 0.60);
  end if;

  -- Dwell: mild positive (log-scaled, capped at ~20s)
  if et = 'dwell' and NEW.dwell_ms is not null then
    dwell_norm := ln(1 + greatest(0, NEW.dwell_ms)) / ln(1 + 20000);
    pos_inc := pos_inc + 0.20 * least(1.0, dwell_norm);
  end if;
  ...
  set
    ...
    -- Canonical action memory
    last_action = case
      when et in ('like','dislike','skip') then NEW.event_type
      else mf.last_action
    end,
    last_action_at = case
      when et in ('like','dislike','skip') then now_ts
      else mf.last_action_at
    end,

    -- State fields
    rating_0_10 = coalesce(NEW.rating_0_10, mf.rating_0_10),
    in_watchlist = coalesce(NEW.in_watchlist, mf.in_watchlist),

    -- Exposure memory (kept compact)
    last_impression_at = case when et = 'impression' then now_ts else mf.last_impression_at end,
    impressions_7d = case when et = 'impression' then mf.impressions_7d + 1 else mf.impressions_7d end,
    seen_count_total = case when et = 'impression' then mf.seen_count_total + 1 else mf.seen_count_total end,

    -- Dwell memory
    last_dwell_ms = case when NEW.dwell_ms is not null then NEW.dwell_ms else mf.last_dwell_ms end,
    last_dwell_at = case when et = 'dwell' then now_ts else mf.last_dwell_at end,

    -- EMAs (decayed by time since last feedback update)
    positive_ema = (mf.positive_ema * decay) + pos_inc,
    negative_ema = (mf.negative_ema * decay) + neg_inc,
    dwell_ms_ema = (mf.dwell_ms_ema * decay) + case
      when et = 'dwell' and NEW.dwell_ms is not null then NEW.dwell_ms::double precision
      else 0
    end,

    -- Lightweight explainability hooks
    last_why = coalesce(NEW.source, mf.last_why),
    last_rank_score = coalesce((NEW.payload->>'rank_score')::double precision, mf.last_rank_score)

  where mf.user_id = NEW.user_id
    and mf.media_item_id = NEW.media_item_id;
...
--
-- TOC entry 577 (class 1255 OID 153348)
-- Name: apply_media_event_to_feedback_v1(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.apply_media_event_to_feedback_v1() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
  ...
  v_dwell int;
begin
  -- Only these event types should update last_action:
  ...
  if NEW.event_type = 'rating'::public.media_event_type then
    v_rating := NEW.rating_0_10;
  else
    v_rating := null;
  end if;

  if NEW.event_type = 'watchlist'::public.media_event_type then
    v_watchlist := NEW.in_watchlist;
  else
    v_watchlist := null;
  end if;

  if NEW.event_type = 'dwell'::public.media_event_type then
  ...
  set
    last_action = case
      when excluded.last_action is not null then excluded.last_action
    ...
    rating_0_10 = case
      when excluded.rating_0_10 is not null then excluded.rating_0_10
      else public.media_feedback.rating_0_10
    end,
    in_watchlist = case
      when excluded.in_watchlist is not null then excluded.in_watchlist
      else public.media_feedback.in_watchlist
    end,
    last_dwell_ms = case
      when excluded.last_dwell_ms is not null then greatest(coalesce(public.media_feedback.last_dwell_ms, 0), excluded.last_dwell_ms)
      else public.media_feedback.last_dwell_ms
    end;
...
ALTER FUNCTION public.apply_media_event_to_feedback_v1() OWNER TO postgres;

--
-- TOC entry 512 (class 1255 OID 149941)
...
--
-- TOC entry 706 (class 1255 OID 150345)
...
--
-- TOC entry 542 (class 1255 OID 48746)
-- Name: get_conversation_summaries(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_conversation_summaries(p_user_id uuid) RETURNS TABLE(conversation_id uuid, is_group boolean, title text, created_at timestamp with time zone, updated_at timestamp with time zone, last_message_id uuid, last_message_body text, last_message_created_at timestamp with time zone, last_message_user_id uuid, last_message_display_name text, last_message_username text, participants jsonb, self_last_read_message_id uuid, self_last_read_at timestamp with time zone, participant_receipts jsonb)
    LANGUAGE sql STABLE
    SET search_path TO 'public', 'pg_temp'
    AS $$
...
--
-- TOC entry 820 (class 1255 OID 129888)
...
begin
  ...
  with rating_buckets as (
    select
      round((r.rating::numeric) * 2) / 2 as bucket,
...
--
-- TOC entry 645 (class 1255 OID 48787)
...
--
-- TOC entry 776 (class 1255 OID 19184)
...
--
-- TOC entry 634 (class 1255 OID 20284)
...
--
-- TOC entry 608 (class 1255 OID 137966)
...
--
-- TOC entry 791 (class 1255 OID 147914)
...
--
-- TOC entry 661 (class 1255 OID 285442)
-- Name: invoke_media_embed_backfill_openai_edge_with_anon_key(integer, boolean, text, text, integer, text, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.invoke_media_embed_backfill_openai_edge_with_anon_key(batch_size integer DEFAULT 32, reembed boolean DEFAULT false, kind text DEFAULT NULL::text, openai_model text DEFAULT 'text-embedding-3-small'::text, openai_dimensions integer DEFAULT 1024, task text DEFAULT 'retrieval.passage'::text, use_saved_cursor boolean DEFAULT true) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
...
DECLARE
  ...
  v_body jsonb;
BEGIN
  -- Read required secrets from Vault
  SELECT decrypted_secret INTO v_project_url
  FROM vault.decrypted_secrets
  WHERE name = 'project_url'
  LIMIT 1;
  ...
  v_body := jsonb_build_object(
    ...
    'kind', kind,
    -- OpenAI profile fields (your Edge Function must support these to actually switch)
    'provider', 'openai',
    'model', openai_model,
...
ALTER FUNCTION public.invoke_media_embed_backfill_openai_edge_with_anon_key(batch_size integer, reembed boolean, kind text, openai_model text, openai_dimensions integer, task text, use_saved_cursor boolean) OWNER TO postgres;

--
-- TOC entry 524 (class 1255 OID 285568)
...
--
-- TOC entry 726 (class 1255 OID 147678)
...
--
-- TOC entry 510 (class 1255 OID 41790)
...
--
-- TOC entry 497 (class 1255 OID 34350)
...
--
-- TOC entry 642 (class 1255 OID 41791)
...
--
-- TOC entry 825 (class 1255 OID 41789)
...
--
-- TOC entry 488 (class 1255 OID 53406)
...
--
-- TOC entry 555 (class 1255 OID 53407)
...
--
-- TOC entry 593 (class 1255 OID 148238)
...
--
-- TOC entry 607 (class 1255 OID 135426)
...
--
-- TOC entry 652 (class 1255 OID 141196)
...
--
-- TOC entry 734 (class 1255 OID 296060)
...
begin
  ...
  -- Pull last N strong positives with embeddings available
  with likes as (
  ...
  -- exemplar 2 = farthest from exemplar 1
  with cand as (
    select l.media_item_id,
           (me.embedding <=> me1.embedding) as d1
    from (
      select distinct media_item_id from public.media_events
  ...
  if k >= 3 and ex2 is not null then
    -- exemplar 3 = farthest from both (maximize min distance)
    with cand as (
      select l.media_item_id,
             least(
  ...
  -- If k<3, delete higher centroids to keep clean
  delete from public.media_user_centroids
  where user_id=p_user_id
...
--
-- TOC entry 660 (class 1255 OID 153116)
...
--
-- TOC entry 787 (class 1255 OID 295576)
  ...
  enriched as (
    select
      ...
      (select min(g.slug)
       ...
       join public.genres g on g.id=tg.genre_id
       where tg.title_id=j.media_item_id
      ) as primary_genre,
...
--
-- TOC entry 716 (class 1255 OID 316424)
...
declare
  ...
  -- diversity caps (soft constraints; applied in final stage)
...
begin
  ...
  -- recent strong positive for explanation
  select e.media_item_id
    into v_recent_like_id
  from public.media_events e
  where e.user_id=v_user_id
  ...
  create temporary table if not exists _seen24h (
    media_item_id uuid primary key
  ) on commit drop;
  ...
  from (
    -- feedback impressions (if you maintain them)
    select mf.media_item_id
    from public.media_feedback mf
    where mf.user_id = v_user_id
    ...
    -- events that indicate the user already saw it recently
    select e.media_item_id
    from public.media_events e
    where e.user_id = v_user_id
      and e.created_at > now() - interval '24 hours'
      and e.event_type::text in ('impression','dwell','skip','open','seen','like','dislike')
  ) x
  on conflict (media_item_id) do nothing;

  create temporary table if not exists _blocked (
    media_item_id uuid primary key
  ) on commit drop;
  ...
  select x.media_item_id
  from (
    -- DB-side feedback (if you maintain it)
    select mf.media_item_id
    from public.media_feedback mf
    where mf.user_id = v_user_id
      and (
        mf.last_action::text = 'dislike'
        or coalesce(mf.negative_ema,0) >= 0.95
        or (mf.last_impression_at is not null and mf.last_impression_at > now() - interval '1 hour')
      )

    union

    -- App-side events (this is what the Edge swipe-event function writes)
    select e.media_item_id
    from public.media_events e
    where e.user_id = v_user_id
      and e.created_at > now() - interval '365 days'
      and (
        e.event_type::text in ('like','dislike','seen','open')
        or (e.event_type::text='watchlist' and e.in_watchlist = true)
        or (e.event_type::text='rating' and e.rating_0_10 is not null and e.rating_0_10 >= 7)
      )
  ) x
  on conflict (media_item_id) do nothing;

  create temporary table if not exists _served30m (
    media_item_id uuid primary key
  ) on commit drop;
  ...
  where ms.user_id = v_user_id
    and ms.served_at > now() - interval '7 days'
  on conflict (media_item_id) do nothing;
  ...
  params as (
    select
      ...
      v_kind_filter as kind_filter,
      v_seed as seed,
      v_has_vec as has_vec
  ),
  -- Hard blocked set is materialized into temp table _blocked (see above)
  -- Soft "seen recently" set is materialized into temp table _seen24h (see above)
  ...
  -- (A) For-you: vector-based if available
  for_you_vec as (
    select
      e.media_item_id,
      max(
  ...
  -- (B) For-you fallback: genre-based if no vec (still "Matched for you" but weaker)
  top_genres as (
    select g.slug, count(*) as cnt
    from public.media_events ev
    join public.title_genres tg on tg.title_id = ev.media_item_id
    join public.genres g on g.id = tg.genre_id
    where ev.user_id = v_user_id
      and ev.created_at > now() - interval '180 days'
      and (
        ev.event_type::text='like'
        or (ev.event_type::text='watchlist' and ev.in_watchlist=true)
        or (ev.event_type::text='rating' and ev.rating_0_10>=7)
        or (ev.event_type::text='dwell' and ev.dwell_ms>=12000)
      )
    group by g.slug
    order by cnt desc
    limit 5
  ...
  for_you_genre as (
    select
      mi.id as media_item_id,
      -- popularity + vote_average for ranking; add tiny seed jitter later
      (coalesce(mi.tmdb_popularity,0)::double precision * 0.7
       + coalesce(mi.tmdb_vote_average,0)::double precision * 10.0) as score
    from public.media_items mi
    where not (select has_vec from params)
      and exists (
        select 1 from public.title_genres tg
        join public.genres g on g.id=tg.genre_id
        join top_genres tg2 on tg2.slug=g.slug
        where tg.title_id = mi.id
      )
      and not exists (select 1 from _blocked b where b.media_item_id=mi.id)
    order by score desc
    limit (v_limit * 40)
  ),

    -- (C) Trending: restrict "Trending now" to fairly recent releases/air-dates.
  -- Older titles can still surface, but they are labeled "Popular now" instead.
  trending_recent as (
    select
      t.media_item_id,
      (
        t.score_72h
        * exp(-extract(epoch from (now() - t.computed_at)) / (18*3600.0))  -- stale trending fades quickly
  ...
  popular_catalog as (
    select
      ...
      (
        t.score_72h
        * exp(-extract(epoch from (now() - t.computed_at)) / (24*3600.0))
        * 0.55
      )::double precision as score
    from public.media_trending_scores t
    join public.media_items mi on mi.id=t.media_item_id
  ...
  -- (D) Friends: return friend_ids (for avatar stacks)
  friend_events as (
    select
      e.media_item_id,
  ...
  -- Pool (vector-for-you preferred, else genre-for-you)
  pool as (
    select media_item_id, score, 'for_you'::text as source, null::uuid[] as friend_ids
    from for_you_vec
    union all
    select media_item_id, score, 'for_you'::text as source, null::uuid[] as friend_ids
    from for_you_genre
    union all
    select media_item_id, score, 'popular'::text as source, null::uuid[] as friend_ids
    from trending_recent
    union all
    select media_item_id, score, 'popular'::text as source, null::uuid[] as friend_ids
    from popular_catalog
    union all
    select media_item_id, score, 'friends'::text as source, friend_ids
    from friends
  ),

  -- Join media metadata + global filters
  joined as (
    select
      p.media_item_id,
      p.score,
      ...
      (select min(g.slug)
       from public.title_genres tg
       join public.genres g on g.id=tg.genre_id
       where tg.title_id = p.media_item_id
      ) as primary_genre
    from pool p
    join public.media_items mi on mi.id=p.media_item_id
  ...
  -- Score calibration per source (percentile) + novelty penalties
  with_fb as (
    select
      j.*,
      coalesce(mf.impressions_7d,0) as impressions_7d,
    ...
    from joined j
    left join public.media_feedback mf
      on mf.user_id=v_user_id and mf.media_item_id=j.media_item_id
  ),

  normed as (
    select
      wf.*,
      (1.0 - percent_rank() over (partition by wf.source order by wf.score desc)) as rel,
      (
        0.12 * ln(1.0 + wf.impressions_7d::double precision)
        + case when wf.last_impression_at is null then 0.0
               when wf.last_impression_at > now() - interval '24 hours' then 0.08
  ...
  scored as (
    select
      n.*,
      -- linear-ish score that balances relevance, novelty, negativity, and jitter
      (
        1.00 * n.rel
        - 0.25 * n.novelty
        - 0.30 * n.negative_ema
        + 0.10 * n.jit
        + case n.source when 'for_you' then 0.05 when 'friends' then 0.04 when 'trending' then 0.03 else 0.015 end
      ) as final_score
    from normed n
  ),

  -- IMPORTANT: dedupe by media_item_id BEFORE upsert into _cand (avoid "conflict twice")
  deduped as (
    select distinct on (s.media_item_id)
      s.media_item_id,
      s.source,
    ...
    order by
      s.media_item_id,
      s.final_score desc,
      case s.source when 'for_you' then 1 when 'friends' then 2 when 'trending' then 3 else 4 end
  )

  insert into _cand(media_item_id, source, score, jit, final_score, primary_genre, collection_id, friend_ids)
  select
    d.media_item_id, d.source, d.score, d.jit, d.final_score, d.primary_genre, d.collection_id, d.friend_ids
  from deduped d
  on conflict (media_item_id) do update
  ...
  -- Fallback: if candidate pool is too small, add popular recent items so the deck never comes back empty.
  if (select count(*) from _cand) < v_limit then
    insert into _cand(media_item_id, source, score, jit, final_score, primary_genre, collection_id, friend_ids)
    select
      mi.id as media_item_id,
      'trending'::text as source,
      -- raw score: popularity + votes + recency (recent gets a boost)
      (
        coalesce(mi.tmdb_popularity, 0)::double precision * 0.7
        + coalesce(mi.tmdb_vote_average, 0)::double precision * 8.0
        + 5.0 * exp(-greatest(0.0, extract(epoch from (now()::timestamptz - coalesce(mi.tmdb_release_date, mi.tmdb_first_air_date, now()::date)::timestamptz)))/86400.0 / 90.0)
      ) as score,
      (
      ...
      (
        1.0 * (
          -- normalize-ish: use sigmoid-like squashing
          1.0 / (1.0 + exp(-(
            coalesce(mi.tmdb_vote_average,0)::double precision - 6.5
          )))
        )
        + 0.03 * (
          (((hashtext(v_seed || mi.id::text))::bigint % 100000 + 100000) % 100000)::double precision / 100000.0
        )
        + 0.02  -- popular baseline
      ) as final_score,
      (select min(g.slug)
       from public.title_genres tg
       join public.genres g on g.id=tg.genre_id
      ...
      (mi.tmdb_belongs_to_collection ->> 'id') as collection_id,
      null::uuid[] as friend_ids
    from public.media_items mi
    where coalesce(mi.completeness,1.0) >= 0.10
  ...
  -- QUOTAS + two-tier seen filtering:
  -- Tier 1: exclude seen_24h; Tier 2: allow seen_24h if we still can't fill.
  declare
    q_fy int;
    q_tr int;
    q_fr int;
  ...
  begin
    if v_mode='for_you' then
      ...
      if v_has_vec then
        ...
        -- cold-start: more trending + friends
        q_fy := ceil(v_limit*0.40)::int;  -- for_you_genre still possible
        q_tr := ceil(v_limit*0.40)::int;
        q_fr := v_limit - q_fy - q_tr;
      end if;
    end if;

    -- helper: insert selected rows into _take, excluding seen_24h
    with ranked as (
      select c.*,
    ...
    insert into _take(media_item_id, source, final_score, primary_genre, collection_id, friend_ids)
    select media_item_id, source, final_score, primary_genre, collection_id, friend_ids
    from chosen
    on conflict (media_item_id) do update
      set source=excluded.source,
          final_score=excluded.final_score,
    ...
    -- Tier 2 fallback: allow seen_24h if not enough
    select greatest(0, v_limit - (select count(*) from _take)) into need_more;
    if need_more > 0 then
      insert into _take(media_item_id, source, final_score, primary_genre, collection_id, friend_ids)
      select c.media_item_id, c.source, c.final_score, c.primary_genre, c.collection_id, c.friend_ids
      from _cand c
    ...
    -- Tier 3 fallback: if we STILL can't fill (tiny catalog), allow recently served items,
    -- but shuffle slightly so refresh isn't identical.
    select greatest(0, v_limit - (select count(*) from _take)) into need_more;
    if need_more > 0 then
      insert into _take(media_item_id, source, final_score, primary_genre, collection_id, friend_ids)
      select c.media_item_id, c.source, c.final_score, c.primary_genre, c.collection_id, c.friend_ids
  ...
  -- Final diversity-aware picking (primary genre + collection caps)
  for i in 1..v_limit loop
    with cand as (
      select
        t.*,
    ...
    insert into _picked(pos, media_item_id, source, final_score, friend_ids)
    select i, media_item_id, source, final_score, friend_ids from cand
    on conflict (pos) do nothing;
  ...
  -- Mark served items (not impressions) so refresh doesn't immediately repeat the same deck.
  ...
  -- Emergency fallback: if we still couldn't pick anything (e.g., completeness not populated yet),
  -- return a simple popular-recent list so the UI never shows "All caught up".
  if (select count(*) from _picked) = 0 then
    insert into _picked(pos, media_item_id, source, final_score, friend_ids)
    select
      row_number() over (order by (coalesce(mi.tmdb_popularity,0) + coalesce(mi.tmdb_vote_count,0)) desc)::int as pos,
      mi.id,
    ...
    where (v_kind_filter is null or lower(mi.kind::text)=v_kind_filter)
      and mi.id not in (select media_item_id from _blocked)
      and mi.id not in (select media_item_id from _served30m)
  ...
  -- Return payload with why + friend_ids
  return query
  select
    mi.id as media_item_id,
    coalesce(mi.tmdb_title, mi.tmdb_name, mi.omdb_title, 'Untitled') as title,
    ...
    case p.source
      when 'for_you' then
        case when v_recent_like_title is not null then 'Matched for you · because you liked ' || v_recent_like_title
             else 'Matched for you' end
      when 'friends' then 'Friends’ picks'
      when 'popular' then 'Popular now'
      else 'Trending now'
    end as why,
...
--
-- TOC entry 750 (class 1255 OID 295494)
-- Name: media_update_taste_vectors_v1(uuid, uuid, text, integer, numeric, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.media_update_taste_vectors_v1(p_session_id uuid, p_media_item_id uuid, p_event_type text, p_dwell_ms integer, p_rating_0_10 numeric, p_in_watchlist boolean) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'extensions', 'pg_temp'
    AS $$
declare
  ...
  v_emb vector;              -- inferred: vector(N)
  w_user float8 := 0.0;      -- long-term weight
  w_sess float8 := 0.0;      -- session weight

  alpha_pos float8 := 0.15;
  alpha_neg float8 := 0.15;
  alpha_dwell float8 := 0.20;
...
begin
  ...
  -- 1) Active embedding profile (confirmed table: embedding_settings)
  select active_provider, active_model, active_dimensions, active_task
    into v_provider, v_model, v_dims, v_task
  from public.embedding_settings
  where id = 1;

  -- 2) Fetch item embedding for that profile
  select e.embedding
    into v_emb
  from public.media_embeddings e
  where e.media_item_id = p_media_item_id
    ...
    and e.model = v_model
    and e.dimensions = v_dims
    and e.task = v_task;

  if v_emb is null then
    -- No embedding => still update feedback & daily stats, but no vector updates.
    -- (This happens during backfill / missing items.)
    null;
  end if;

  -- 3) Compute weights (inferred but matches product intent)
  case lower(coalesce(p_event_type, ''))
    when 'like' then
      w_user := 1.0;  w_sess := 1.2;
    when 'dislike' then
      w_user := -1.0; w_sess := -1.2;
    when 'skip' then
      w_user := -0.2; w_sess := -0.25;
    when 'watchlist' then
      if p_in_watchlist is true then
        w_user := 0.8; w_sess := 0.9;
      else
        w_user := -0.1; w_sess := -0.1;
      end if;
    when 'rating' then
      if p_rating_0_10 is not null then
        w_user := greatest(-1.0, least(1.0, ((p_rating_0_10 - 5.0) / 5.0)));
        w_sess := w_user;
      end if;
    when 'dwell' then
      if p_dwell_ms is not null then
        w_user := case
          when p_dwell_ms >= 20000 then 0.35
          when p_dwell_ms >= 12000 then 0.25
          when p_dwell_ms >=  5000 then 0.12
          when p_dwell_ms >=  2000 then 0.05
          else 0.0 end;
        w_sess := w_user;
      end if;
    else
      w_user := 0.0; w_sess := 0.0;
  end case;

  -- 4) Update per-item feedback state (confirmed table columns)
  insert into public.media_feedback as mf (
    user_id, media_item_id,
    last_action, last_action_at,
    rating_0_10, in_watchlist,
    last_dwell_ms, last_dwell_at,
    last_impression_at,
    impressions_7d, seen_count_total,
    dwell_ms_ema, positive_ema, negative_ema,
    updated_at
  )
  values (
    v_user_id, p_media_item_id,
    p_event_type::text, v_now,
    p_rating_0_10, p_in_watchlist,
    p_dwell_ms, case when lower(p_event_type)='dwell' then v_now else null end,
    case when lower(p_event_type)='impression' then v_now else null end,
    case when lower(p_event_type)='impression' then 1 else 0 end,
    case when lower(p_event_type)='seen' then 1 else 0 end,
    coalesce(p_dwell_ms, 0),
    case when w_user > 0 then w_user else 0 end,
    case when w_user < 0 then abs(w_user) else 0 end,
    v_now
  )
  on conflict (user_id, media_item_id) do update
    set last_action       = excluded.last_action,
        last_action_at    = excluded.last_action_at,
        rating_0_10       = coalesce(excluded.rating_0_10, mf.rating_0_10),
        in_watchlist      = coalesce(excluded.in_watchlist, mf.in_watchlist),
        last_dwell_ms     = coalesce(excluded.last_dwell_ms, mf.last_dwell_ms),
        last_dwell_at     = coalesce(excluded.last_dwell_at, mf.last_dwell_at),
        last_impression_at= coalesce(excluded.last_impression_at, mf.last_impression_at),
        impressions_7d    = mf.impressions_7d + (case when lower(p_event_type)='impression' then 1 else 0 end),
        seen_count_total  = mf.seen_count_total + (case when lower(p_event_type)='seen' then 1 else 0 end),
        dwell_ms_ema      = (1 - alpha_dwell) * mf.dwell_ms_ema + alpha_dwell * coalesce(p_dwell_ms, 0),
        positive_ema      = (1 - alpha_pos) * mf.positive_ema + alpha_pos * (case when w_user > 0 then w_user else 0 end),
        negative_ema      = (1 - alpha_neg) * mf.negative_ema + alpha_neg * (case when w_user < 0 then abs(w_user) else 0 end),
        updated_at        = v_now;

  -- 5) Daily aggregates (for trending) — inferred but matches schema
  -- unique user tracking
  insert into public.media_item_daily_users(day, media_item_id, user_id)
  values (v_day, p_media_item_id, v_user_id)
  on conflict do nothing;

  insert into public.media_item_daily as d (
    day, media_item_id,
  ...
  values (
    v_day, p_media_item_id,
    case when lower(p_event_type)='impression' then 1 else 0 end,
    case when lower(p_event_type)='dwell' then 1 else 0 end,
    case when lower(p_event_type)='dwell' then coalesce(p_dwell_ms,0) else 0 end,
    case when lower(p_event_type)='like' then 1 else 0 end,
    case when lower(p_event_type)='dislike' then 1 else 0 end,
    case when lower(p_event_type)='skip' then 1 else 0 end,
    case when lower(p_event_type)='watchlist' then 1 else 0 end,
    case when lower(p_event_type)='rating' then 1 else 0 end,
    1,
    v_now
  )
  on conflict (day, media_item_id) do update
    set impressions      = d.impressions + excluded.impressions,
        dwell_events     = d.dwell_events + excluded.dwell_events,
        dwell_ms_sum     = d.dwell_ms_sum + excluded.dwell_ms_sum,
        likes            = d.likes + excluded.likes,
        dislikes         = d.dislikes + excluded.dislikes,
        skips            = d.skips + excluded.skips,
        watchlist_events = d.watchlist_events + excluded.watchlist_events,
        rating_events    = d.rating_events + excluded.rating_events,
        unique_users     = (select count(*) from public.media_item_daily_users u
                            where u.day=d.day and u.media_item_id=d.media_item_id),
        updated_at       = v_now;

  -- 6) Vector updates (inferred core)
  if v_emb is not null and (w_user <> 0 or w_sess <> 0) then
    -- session vector
    insert into public.media_session_vectors as sv (
      user_id, session_id, taste, updated_at, provider, model, dimensions, task
    )
    values (v_user_id, p_session_id, (w_sess * v_emb), v_now, v_provider, v_model, v_dims, v_task)
    on conflict (user_id, session_id, provider, model, dimensions, task) do update
      set taste = sv.taste + (w_sess * v_emb),
          updated_at = v_now;

    -- user vector
    insert into public.media_user_vectors as uv (
      user_id, taste, updated_at, provider, model, dimensions, task
    )
    values (v_user_id, (w_user * v_emb), v_now, v_provider, v_model, v_dims, v_task)
    on conflict (user_id, provider, model, dimensions, task) do update
      set taste = uv.taste + (w_user * v_emb),
          updated_at = v_now;
  end if;
...
ALTER FUNCTION public.media_update_taste_vectors_v1(p_session_id uuid, p_media_item_id uuid, p_event_type text, p_dwell_ms integer, p_rating_0_10 numeric, p_in_watchlist boolean) OWNER TO postgres;

--
-- TOC entry 792 (class 1255 OID 152801)
...
declare
  ...
  v_alpha_session double precision := 0.25; -- faster adaptation
  v_alpha_user double precision := 0.05;    -- slower adaptation
...
begin
  ...
  -- Map event -> weight (small bounded updates)
  if p_event_type = 'like'::public.media_event_type then
    ...
    v_weight := -0.25;
  elsif p_event_type = 'watchlist'::public.media_event_type then
    -- toggles: true is positive, false is mild negative
    if p_in_watchlist is true then v_weight := 0.60; else v_weight := -0.20; end if;
  elsif p_event_type = 'rating'::public.media_event_type then
    -- center around 5 -> [-1..1], then scale down
    ...
    -- assumes dwell is already bucketed: 2000 / 5000 / 12000 / 20000
    ...
    -- unknown / not supported for taste
  ...
  -- Load the item's embedding (latest row for that item).
  -- If you store multiple models/tasks, this picks the newest.
  select me.embedding
    into v_emb
  from public.media_embeddings me
  ...
  if v_old_session is null then
    v_new_session := (v_emb * v_weight::float4);
  else
    v_new_session := (v_old_session * (1.0 - v_alpha_session)::float4) + (v_emb * (v_alpha_session * v_weight)::float4);
  end if;

  insert into public.media_session_vectors (session_id, user_id, taste, updated_at)
  values (p_session_id, v_user_id, v_new_session, now())
  ...
  if v_old_user is null then
    v_new_user := (v_emb * (v_weight::float4 * 0.50)); -- softer init
  else
    v_new_user := (v_old_user * (1.0 - v_alpha_user)::float4) + (v_emb * (v_alpha_user * v_weight)::float4);
  end if;

  insert into public.media_user_vectors (user_id, taste, updated_at)
  values (v_user_id, v_new_user, now())
  on conflict (user_id) do update
...
--
-- TOC entry 516 (class 1255 OID 295956)
...
--
-- TOC entry 808 (class 1255 OID 147554)
...
--
-- TOC entry 676 (class 1255 OID 154215)
...
--
-- TOC entry 703 (class 1255 OID 285830)
...
--
-- TOC entry 572 (class 1255 OID 291584)
...
--
-- TOC entry 669 (class 1255 OID 32553)
...
--
-- TOC entry 597 (class 1255 OID 49086)
-- Name: sync_messages_user_and_sender_id(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.sync_messages_user_and_sender_id() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO 'public'
    AS $$
BEGIN
  -- If only sender_id is set, copy it into user_id
  IF NEW.user_id IS NULL AND NEW.sender_id IS NOT NULL THEN
    NEW.user_id := NEW.sender_id;

  -- If only user_id is set, copy it into sender_id
...
ALTER FUNCTION public.sync_messages_user_and_sender_id() OWNER TO postgres;

--
-- TOC entry 705 (class 1255 OID 293491)
...
declare
  ...
  v_omdb_genre text;
begin
  delete from public.title_genres tg where tg.title_id = p_title_id;
...
--
-- TOC entry 684 (class 1255 OID 24458)
-- Name: titles_tsvector_trigger(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.titles_tsvector_trigger() RETURNS trigger
    LANGUAGE plpgsql
...
ALTER FUNCTION public.titles_tsvector_trigger() OWNER TO postgres;

--
-- TOC entry 695 (class 1255 OID 53405)
...
--
-- TOC entry 519 (class 1255 OID 17387)
...
--
-- TOC entry 683 (class 1255 OID 17466)
...
--
-- TOC entry 511 (class 1255 OID 17399)
...
--
-- TOC entry 628 (class 1255 OID 17159)
...
--
-- TOC entry 615 (class 1255 OID 17154)
...
--
-- TOC entry 752 (class 1255 OID 17395)
...
--
-- TOC entry 659 (class 1255 OID 17406)
...
--
-- TOC entry 757 (class 1255 OID 17153)
...
--
-- TOC entry 702 (class 1255 OID 17465)
...
--
-- TOC entry 701 (class 1255 OID 17151)
...
--
-- TOC entry 520 (class 1255 OID 17376)
...
--
-- TOC entry 762 (class 1255 OID 17459)
...
--
-- TOC entry 611 (class 1255 OID 17277)
...
--
-- TOC entry 574 (class 1255 OID 17200)
...
--
-- TOC entry 648 (class 1255 OID 17319)
...
--
-- TOC entry 707 (class 1255 OID 17278)
...
--
-- TOC entry 526 (class 1255 OID 17281)
...
--
-- TOC entry 586 (class 1255 OID 17298)
...
--
-- TOC entry 758 (class 1255 OID 17163)
...
--
-- TOC entry 681 (class 1255 OID 17162)
...
--
-- TOC entry 493 (class 1255 OID 17161)
...
--
-- TOC entry 622 (class 1255 OID 17259)
...
--
-- TOC entry 523 (class 1255 OID 17275)
...
--
-- TOC entry 561 (class 1255 OID 17276)
...
--
-- TOC entry 644 (class 1255 OID 17296)
...
--
-- TOC entry 800 (class 1255 OID 17242)
...
--
-- TOC entry 535 (class 1255 OID 17205)
...
--
-- TOC entry 556 (class 1255 OID 17318)
...
--
-- TOC entry 616 (class 1255 OID 17320)
...
--
-- TOC entry 598 (class 1255 OID 17280)
...
--
-- TOC entry 743 (class 1255 OID 17321)
...
--
-- TOC entry 532 (class 1255 OID 17326)
...
--
-- TOC entry 478 (class 1255 OID 17297)
...
--
-- TOC entry 641 (class 1255 OID 17258)
...
--
-- TOC entry 536 (class 1255 OID 17322)
...
--
-- TOC entry 664 (class 1255 OID 17279)
...
--
-- TOC entry 751 (class 1255 OID 17189)
...
--
-- TOC entry 741 (class 1255 OID 17294)
...
--
-- TOC entry 799 (class 1255 OID 17293)
...
--
-- TOC entry 646 (class 1255 OID 17317)
...
--
-- TOC entry 680 (class 1255 OID 17190)
...
--
-- TOC entry 461 (class 1259 OID 285049)
-- Name: embedding_settings; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.embedding_settings (
    id integer NOT NULL,
    active_provider text DEFAULT 'jina'::text NOT NULL,
    active_model text DEFAULT 'jina-embeddings-v3'::text NOT NULL,
    active_dimensions integer DEFAULT 1024 NOT NULL,
    active_task text DEFAULT 'retrieval.passage'::text NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    ...
    admin_daily_token_budget_by_provider jsonb DEFAULT '{}'::jsonb NOT NULL,
...
--
-- TOC entry 462 (class 1259 OID 286546)
...
--
-- TOC entry 467 (class 1259 OID 287121)
...
--
-- TOC entry 469 (class 1259 OID 287154)
...
--
-- TOC entry 466 (class 1259 OID 287112)
...
--
-- TOC entry 468 (class 1259 OID 287132)
...
--
-- TOC entry 443 (class 1259 OID 135411)
...
CREATE TABLE public.media_items (
    ...
    omdb_ratings jsonb GENERATED ALWAYS AS ((omdb_raw -> 'Ratings'::text)) STORED,
    tmdb_budget bigint GENERATED ALWAYS AS ((NULLIF(((tmdb_raw -> 'details'::text) ->> 'budget'::text), ''::text))::bigint) STORED,
    tmdb_revenue bigint GENERATED ALWAYS AS ((NULLIF(((tmdb_raw -> 'details'::text) ->> 'revenue'::text), ''::text))::bigint) STORED,
    tmdb_runtime integer GENERATED ALWAYS AS ((NULLIF(((tmdb_raw -> 'details'::text) ->> 'runtime'::text), ''::text))::integer) STORED,
    tmdb_tagline text GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) ->> 'tagline'::text)) STORED,
    tmdb_homepage text GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) ->> 'homepage'::text)) STORED,
    tmdb_imdb_id text GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) ->> 'imdb_id'::text)) STORED,
    tmdb_genres jsonb GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) -> 'genres'::text)) STORED,
    tmdb_spoken_languages jsonb GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) -> 'spoken_languages'::text)) STORED,
    tmdb_production_companies jsonb GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) -> 'production_companies'::text)) STORED,
    tmdb_production_countries jsonb GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) -> 'production_countries'::text)) STORED,
    tmdb_belongs_to_collection jsonb GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) -> 'belongs_to_collection'::text)) STORED,
    tmdb_source text GENERATED ALWAYS AS ((tmdb_raw ->> 'source'::text)) STORED,
    tmdb_release_status text GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) ->> 'status'::text)) STORED,
    tmdb_origin_country_raw jsonb GENERATED ALWAYS AS (((tmdb_raw -> 'details'::text) -> 'origin_country'::text)) STORED,
    ...
    CONSTRAINT media_items_imdb_id_format_chk CHECK (((omdb_imdb_id IS NULL) OR (omdb_imdb_id ~ '^tt[0-9]{7,8}$'::text))),
...
--
-- TOC entry 446 (class 1259 OID 146828)
...
--
-- TOC entry 447 (class 1259 OID 146833)
...
--
-- TOC entry 463 (class 1259 OID 286550)
...
--
-- TOC entry 448 (class 1259 OID 146873)
...
--
-- TOC entry 449 (class 1259 OID 146895)
...
--
-- TOC entry 456 (class 1259 OID 150305)
...
--
-- TOC entry 457 (class 1259 OID 150327)
...
--
-- TOC entry 458 (class 1259 OID 150340)
...
--
-- TOC entry 459 (class 1259 OID 154206)
...
--
-- TOC entry 476 (class 1259 OID 295881)
...
--
-- TOC entry 475 (class 1259 OID 295869)
...
--
-- TOC entry 471 (class 1259 OID 291572)
...
--
-- TOC entry 477 (class 1259 OID 325903)
...
--
-- TOC entry 451 (class 1259 OID 146927)
...
--
-- TOC entry 465 (class 1259 OID 286558)
...
--
-- TOC entry 452 (class 1259 OID 146940)
...
--
-- TOC entry 474 (class 1259 OID 295826)
...
--
-- TOC entry 450 (class 1259 OID 146914)
...
--
-- TOC entry 464 (class 1259 OID 286554)
...
--
-- TOC entry 445 (class 1259 OID 137055)
...
--
-- TOC entry 472 (class 1259 OID 293474)
...
--
-- TOC entry 444 (class 1259 OID 136524)
...
--
-- TOC entry 453 (class 1259 OID 146951)
...
--
-- TOC entry 441 (class 1259 OID 112019)
...
--
-- TOC entry 442 (class 1259 OID 133159)
...
--
-- TOC entry 454 (class 1259 OID 147850)
...
--
-- TOC entry 455 (class 1259 OID 147862)
...
--
-- TOC entry 460 (class 1259 OID 155039)
...
--
-- TOC entry 470 (class 1259 OID 287360)
...
--
-- TOC entry 473 (class 1259 OID 293905)
...
--
-- TOC entry 4413 (class 2604 OID 16510)
...
--
-- TOC entry 4524 (class 2604 OID 35303)
...
--
-- TOC entry 4525 (class 2604 OID 35326)
...
--
-- TOC entry 4787 (class 2606 OID 16829)
...
--
-- TOC entry 4765 (class 2606 OID 16953)
...
--
-- TOC entry 4767 (class 2606 OID 16963)
...
--
-- TOC entry 4785 (class 2606 OID 16810)
...
--
-- TOC entry 4777 (class 2606 OID 17003)
...
--
-- TOC entry 4779 (class 2606 OID 16797)
...
--
-- TOC entry 4823 (class 2606 OID 17062)
...
--
-- TOC entry 4825 (class 2606 OID 17060)
...
--
-- TOC entry 4827 (class 2606 OID 17058)
...
--
-- TOC entry 5004 (class 2606 OID 107899)
...
--
-- TOC entry 4820 (class 2606 OID 17022)
...
--
-- TOC entry 4831 (class 2606 OID 17084)
...
--
-- TOC entry 4736 (class 2606 OID 16740)
...
--
-- TOC entry 4799 (class 2606 OID 16869)
...
--
-- TOC entry 4801 (class 2606 OID 16867)
...
--
-- TOC entry 4772 (class 2606 OID 16761)
...
--
-- TOC entry 4791 (class 2606 OID 16841)
...
--
-- TOC entry 4726 (class 2606 OID 16923)
...
--
-- TOC entry 4918 (class 2606 OID 35104)
...
--
-- TOC entry 5102 (class 2606 OID 287130)
...
--
-- TOC entry 5109 (class 2606 OID 287161)
...
--
-- TOC entry 5099 (class 2606 OID 287120)
...
--
-- TOC entry 4987 (class 2606 OID 35403)
...
--
-- TOC entry 4915 (class 2606 OID 35085)
...
--
-- TOC entry 4890 (class 2606 OID 34954)
...
--
-- TOC entry 4935 (class 2606 OID 35162)
...
--
-- TOC entry 4929 (class 2606 OID 55423)
...
--
-- TOC entry 4931 (class 2606 OID 35144)
...
--
-- TOC entry 5097 (class 2606 OID 285061)
...
--
-- TOC entry 4907 (class 2606 OID 35046)
...
--
-- TOC entry 4969 (class 2606 OID 35309)
...
--
-- TOC entry 4971 (class 2606 OID 35307)
...
--
-- TOC entry 4973 (class 2606 OID 35311)
...
--
-- TOC entry 5106 (class 2606 OID 287143)
...
--
-- TOC entry 4879 (class 2606 OID 34915)
...
--
-- TOC entry 4903 (class 2606 OID 35016)
...
--
-- TOC entry 4896 (class 2606 OID 34990)
...
--
-- TOC entry 5042 (class 2606 OID 285191)
...
--
-- TOC entry 5052 (class 2606 OID 146881)
...
--
-- TOC entry 5060 (class 2606 OID 146902)
...
--
-- TOC entry 5086 (class 2606 OID 150319)
...
--
-- TOC entry 5089 (class 2606 OID 150331)
...
--
-- TOC entry 5022 (class 2606 OID 135421)
...
--
-- TOC entry 5091 (class 2606 OID 154213)
...
--
-- TOC entry 5134 (class 2606 OID 295891)
...
--
-- TOC entry 5130 (class 2606 OID 295880)
...
--
-- TOC entry 5115 (class 2606 OID 291582)
...
--
-- TOC entry 5140 (class 2606 OID 325908)
...
--
-- TOC entry 5070 (class 2606 OID 285203)
...
--
-- TOC entry 5073 (class 2606 OID 146945)
...
--
-- TOC entry 5127 (class 2606 OID 295857)
...
--
-- TOC entry 5066 (class 2606 OID 285197)
...
--
-- TOC entry 4956 (class 2606 OID 35234)
...
--
-- TOC entry 4958 (class 2606 OID 130623)
...
--
-- TOC entry 4947 (class 2606 OID 35207)
...
--
-- TOC entry 4949 (class 2606 OID 35521)
...
--
-- TOC entry 4964 (class 2606 OID 35258)
...
--
-- TOC entry 4942 (class 2606 OID 35186)
...
--
-- TOC entry 4995 (class 2606 OID 48658)
...
--
-- TOC entry 4926 (class 2606 OID 35126)
...
--
-- TOC entry 5036 (class 2606 OID 137062)
...
--
-- TOC entry 4975 (class 2606 OID 35330)
...
--
-- TOC entry 4865 (class 2606 OID 24616)
...
--
-- TOC entry 4867 (class 2606 OID 24623)
...
--
-- TOC entry 4870 (class 2606 OID 34890)
...
--
-- TOC entry 4993 (class 2606 OID 35441)
...
--
-- TOC entry 4910 (class 2606 OID 35065)
...
--
-- TOC entry 4912 (class 2606 OID 35519)
...
--
-- TOC entry 5120 (class 2606 OID 293479)
-- Name: title_genres title_genres_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 5032 (class 2606 OID 136531)
...
--
-- TOC entry 4989 (class 2606 OID 35426)
...
--
-- TOC entry 4967 (class 2606 OID 35293)
...
--
-- TOC entry 5076 (class 2606 OID 146962)
...
--
-- TOC entry 4977 (class 2606 OID 35372)
...
--
-- TOC entry 4979 (class 2606 OID 35374)
...
--
-- TOC entry 4983 (class 2606 OID 35385)
...
--
-- TOC entry 4859 (class 2606 OID 17483)
...
--
-- TOC entry 5007 (class 2606 OID 112027)
...
--
-- TOC entry 5010 (class 2606 OID 133167)
...
--
-- TOC entry 5079 (class 2606 OID 147858)
...
--
-- TOC entry 5082 (class 2606 OID 147870)
...
--
-- TOC entry 5095 (class 2606 OID 155047)
...
--
-- TOC entry 5112 (class 2606 OID 287368)
...
--
-- TOC entry 5124 (class 2606 OID 293913)
...
--
-- TOC entry 4839 (class 2606 OID 17147)
...
--
-- TOC entry 4836 (class 2606 OID 17120)
...
--
-- TOC entry 4850 (class 2606 OID 17366)
...
--
-- TOC entry 4853 (class 2606 OID 17342)
...
--
-- TOC entry 4759 (class 2606 OID 16593)
...
--
-- TOC entry 4848 (class 2606 OID 17269)
...
--
-- TOC entry 4845 (class 2606 OID 17230)
...
--
-- TOC entry 4843 (class 2606 OID 17215)
...
--
-- TOC entry 4856 (class 2606 OID 17352)
...
--
-- TOC entry 4861 (class 2606 OID 20113)
...
--
-- TOC entry 4863 (class 2606 OID 20120)
...
--
-- TOC entry 4716 (class 1259 OID 16750)
...
--
-- TOC entry 4717 (class 1259 OID 16752)
...
--
-- TOC entry 4718 (class 1259 OID 16753)
...
--
-- TOC entry 4775 (class 1259 OID 16831)
...
--
-- TOC entry 4808 (class 1259 OID 16939)
...
--
-- TOC entry 4763 (class 1259 OID 16919)
...
--
-- TOC entry 4768 (class 1259 OID 16747)
...
--
-- TOC entry 5002 (class 1259 OID 107900)
...
--
-- TOC entry 4812 (class 1259 OID 16937)
...
--
-- TOC entry 4783 (class 1259 OID 16942)
...
--
-- TOC entry 4780 (class 1259 OID 16803)
...
--
-- TOC entry 4781 (class 1259 OID 16948)
...
--
-- TOC entry 4821 (class 1259 OID 17073)
...
--
-- TOC entry 4818 (class 1259 OID 17026)
...
--
-- TOC entry 4828 (class 1259 OID 17099)
...
--
-- TOC entry 4829 (class 1259 OID 17097)
...
--
-- TOC entry 4834 (class 1259 OID 17098)
...
--
-- TOC entry 4815 (class 1259 OID 16995)
...
--
-- TOC entry 4816 (class 1259 OID 16994)
...
--
-- TOC entry 4817 (class 1259 OID 16996)
...
--
-- TOC entry 4719 (class 1259 OID 16754)
...
--
-- TOC entry 4720 (class 1259 OID 16751)
...
--
-- TOC entry 4731 (class 1259 OID 16746)
...
--
-- TOC entry 4734 (class 1259 OID 16833)
...
--
-- TOC entry 4737 (class 1259 OID 16938)
...
--
-- TOC entry 4802 (class 1259 OID 16875)
...
--
-- TOC entry 4803 (class 1259 OID 16940)
...
--
-- TOC entry 4804 (class 1259 OID 16890)
...
--
-- TOC entry 4807 (class 1259 OID 16889)
...
--
-- TOC entry 4769 (class 1259 OID 16941)
...
--
-- TOC entry 4770 (class 1259 OID 17111)
...
--
-- TOC entry 4773 (class 1259 OID 16832)
...
--
-- TOC entry 4794 (class 1259 OID 16857)
...
--
-- TOC entry 4797 (class 1259 OID 16856)
...
--
-- TOC entry 4792 (class 1259 OID 16842)
...
--
-- TOC entry 4793 (class 1259 OID 17004)
...
--
-- TOC entry 4782 (class 1259 OID 17001)
...
--
-- TOC entry 4774 (class 1259 OID 16830)
...
--
-- TOC entry 4721 (class 1259 OID 16910)
...
--
-- TOC entry 4722 (class 1259 OID 16748)
...
--
-- TOC entry 4724 (class 1259 OID 16965)
...
--
-- TOC entry 4919 (class 1259 OID 48774)
-- Name: activity_events_user_id_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX activity_events_user_id_created_at_idx ON public.activity_events USING btree (user_id, created_at);


--
-- TOC entry 5100 (class 1259 OID 287131)
...
--
-- TOC entry 4984 (class 1259 OID 53391)
...
--
-- TOC entry 4985 (class 1259 OID 53390)
...
--
-- TOC entry 4913 (class 1259 OID 53398)
...
--
-- TOC entry 4888 (class 1259 OID 53397)
...
--
-- TOC entry 4891 (class 1259 OID 53396)
...
--
-- TOC entry 4933 (class 1259 OID 48779)
...
--
-- TOC entry 4936 (class 1259 OID 48768)
...
--
-- TOC entry 4904 (class 1259 OID 48776)
...
--
-- TOC entry 4905 (class 1259 OID 48775)
...
--
-- TOC entry 4920 (class 1259 OID 35118)
...
--
-- TOC entry 4921 (class 1259 OID 52796)
...
--
-- TOC entry 4922 (class 1259 OID 35119)
-- Name: idx_activity_user_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_activity_user_created_at ON public.activity_events USING btree (user_id, created_at DESC);


--
-- TOC entry 4923 (class 1259 OID 35117)
...
--
-- TOC entry 4916 (class 1259 OID 52798)
...
--
-- TOC entry 4892 (class 1259 OID 52799)
...
--
-- TOC entry 4893 (class 1259 OID 52800)
...
--
-- TOC entry 4894 (class 1259 OID 52801)
...
--
-- TOC entry 4932 (class 1259 OID 52802)
...
--
-- TOC entry 4875 (class 1259 OID 52805)
...
--
-- TOC entry 4876 (class 1259 OID 35525)
...
--
-- TOC entry 4877 (class 1259 OID 35526)
-- Name: idx_library_entries_user_title; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_library_entries_user_title ON public.library_entries USING btree (user_id, title_id);


--
-- TOC entry 4899 (class 1259 OID 52806)
...
--
-- TOC entry 4900 (class 1259 OID 52807)
...
--
-- TOC entry 5037 (class 1259 OID 285036)
...
--
-- TOC entry 5068 (class 1259 OID 285146)
...
--
-- TOC entry 5064 (class 1259 OID 285145)
...
--
-- TOC entry 4951 (class 1259 OID 35250)
...
--
-- TOC entry 4952 (class 1259 OID 35251)
...
--
-- TOC entry 4953 (class 1259 OID 52808)
...
--
-- TOC entry 4943 (class 1259 OID 35225)
...
--
-- TOC entry 4944 (class 1259 OID 52809)
...
--
-- TOC entry 4959 (class 1259 OID 52810)
...
--
-- TOC entry 4937 (class 1259 OID 35199)
...
--
-- TOC entry 4938 (class 1259 OID 52811)
...
--
-- TOC entry 4939 (class 1259 OID 52812)
...
--
-- TOC entry 4924 (class 1259 OID 52813)
...
--
-- TOC entry 4868 (class 1259 OID 35524)
...
--
-- TOC entry 4960 (class 1259 OID 35274)
...
--
-- TOC entry 4990 (class 1259 OID 52814)
...
--
-- TOC entry 4991 (class 1259 OID 52815)
...
--
-- TOC entry 4908 (class 1259 OID 52816)
...
--
-- TOC entry 5118 (class 1259 OID 293490)
-- Name: idx_title_genres_genre_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_title_genres_genre_id ON public.title_genres USING btree (genre_id);


--
-- TOC entry 4980 (class 1259 OID 52819)
...
--
-- TOC entry 4981 (class 1259 OID 35396)
...
--
-- TOC entry 5103 (class 1259 OID 287146)
...
--
-- TOC entry 5104 (class 1259 OID 287145)
...
--
-- TOC entry 5107 (class 1259 OID 287144)
...
--
-- TOC entry 4880 (class 1259 OID 48773)
...
--
-- TOC entry 4881 (class 1259 OID 48785)
...
--
-- TOC entry 4882 (class 1259 OID 34916)
...
--
-- TOC entry 4901 (class 1259 OID 53402)
...
--
-- TOC entry 4897 (class 1259 OID 53401)
...
--
-- TOC entry 4898 (class 1259 OID 34992)
...
--
-- TOC entry 5038 (class 1259 OID 146848)
...
--
-- TOC entry 5039 (class 1259 OID 286721)
...
--
-- TOC entry 5040 (class 1259 OID 153781)
...
--
-- TOC entry 5043 (class 1259 OID 286723)
...
--
-- TOC entry 5044 (class 1259 OID 153780)
...
--
-- TOC entry 5045 (class 1259 OID 153779)
...
--
-- TOC entry 5046 (class 1259 OID 342893)
...
--
-- TOC entry 5047 (class 1259 OID 150303)
...
--
-- TOC entry 5048 (class 1259 OID 296018)
...
--
-- TOC entry 5049 (class 1259 OID 150304)
...
--
-- TOC entry 5050 (class 1259 OID 146893)
...
--
-- TOC entry 5053 (class 1259 OID 146894)
...
--
-- TOC entry 5054 (class 1259 OID 152377)
...
--
-- TOC entry 5055 (class 1259 OID 152378)
...
--
-- TOC entry 5056 (class 1259 OID 147328)
...
--
-- TOC entry 5057 (class 1259 OID 146892)
-- Name: media_events_user_time_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX media_events_user_time_idx ON public.media_events USING btree (user_id, created_at DESC);


--
-- TOC entry 5058 (class 1259 OID 154664)
...
--
-- TOC entry 5061 (class 1259 OID 296103)
...
--
-- TOC entry 5062 (class 1259 OID 153347)
...
--
-- TOC entry 5063 (class 1259 OID 146913)
...
--
-- TOC entry 5083 (class 1259 OID 150326)
...
--
-- TOC entry 5084 (class 1259 OID 150325)
...
--
-- TOC entry 5087 (class 1259 OID 150337)
...
--
-- TOC entry 5011 (class 1259 OID 146823)
...
--
-- TOC entry 5012 (class 1259 OID 146824)
...
--
-- TOC entry 5013 (class 1259 OID 135423)
...
--
-- TOC entry 5014 (class 1259 OID 146822)
-- Name: media_items_kind_tmdb_id_uniq; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX media_items_kind_tmdb_id_uniq ON public.media_items USING btree (kind, tmdb_id) WHERE (tmdb_id IS NOT NULL);


--
-- TOC entry 5015 (class 1259 OID 137809)
...
--
-- TOC entry 5016 (class 1259 OID 146325)
...
--
-- TOC entry 5017 (class 1259 OID 148510)
...
--
-- TOC entry 5018 (class 1259 OID 148509)
...
--
-- TOC entry 5019 (class 1259 OID 146331)
...
--
-- TOC entry 5020 (class 1259 OID 146328)
...
--
-- TOC entry 5023 (class 1259 OID 146827)
...
--
-- TOC entry 5024 (class 1259 OID 137808)
...
--
-- TOC entry 5025 (class 1259 OID 146327)
...
--
-- TOC entry 5026 (class 1259 OID 135424)
...
--
-- TOC entry 5027 (class 1259 OID 135896)
...
--
-- TOC entry 5028 (class 1259 OID 146825)
...
--
-- TOC entry 5029 (class 1259 OID 277975)
...
--
-- TOC entry 5030 (class 1259 OID 146826)
...
--
-- TOC entry 5092 (class 1259 OID 154214)
...
--
-- TOC entry 5131 (class 1259 OID 343659)
...
--
-- TOC entry 5132 (class 1259 OID 342634)
...
--
-- TOC entry 5135 (class 1259 OID 342635)
...
--
-- TOC entry 5136 (class 1259 OID 337492)
...
--
-- TOC entry 5137 (class 1259 OID 342632)
...
--
-- TOC entry 5138 (class 1259 OID 295892)
...
--
-- TOC entry 5113 (class 1259 OID 291583)
...
--
-- TOC entry 5116 (class 1259 OID 292103)
...
--
-- TOC entry 5117 (class 1259 OID 292105)
...
--
-- TOC entry 5141 (class 1259 OID 325909)
...
--
-- TOC entry 5071 (class 1259 OID 153114)
...
--
-- TOC entry 5074 (class 1259 OID 147286)
...
--
-- TOC entry 5125 (class 1259 OID 340409)
...
--
-- TOC entry 5128 (class 1259 OID 295868)
...
--
-- TOC entry 5067 (class 1259 OID 153115)
...
--
-- TOC entry 4954 (class 1259 OID 48783)
...
--
-- TOC entry 4945 (class 1259 OID 53389)
...
--
-- TOC entry 4950 (class 1259 OID 48772)
...
--
-- TOC entry 4961 (class 1259 OID 53392)
...
--
-- TOC entry 4962 (class 1259 OID 53393)
...
--
-- TOC entry 4965 (class 1259 OID 48780)
...
--
-- TOC entry 4940 (class 1259 OID 48769)
...
--
-- TOC entry 4927 (class 1259 OID 53404)
...
--
-- TOC entry 5033 (class 1259 OID 283655)
...
--
-- TOC entry 5034 (class 1259 OID 137064)
...
--
-- TOC entry 4871 (class 1259 OID 53400)
-- Name: ratings_title_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ratings_title_id_idx ON public.ratings USING btree (title_id);


--
-- TOC entry 4872 (class 1259 OID 48784)
...
--
-- TOC entry 4873 (class 1259 OID 48770)
...
--
-- TOC entry 4874 (class 1259 OID 34891)
...
--
-- TOC entry 4885 (class 1259 OID 53399)
...
--
-- TOC entry 4886 (class 1259 OID 34942)
-- Name: reviews_title_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX reviews_title_id_idx ON public.reviews USING btree (title_id);


--
-- TOC entry 4887 (class 1259 OID 34943)
...
--
-- TOC entry 5121 (class 1259 OID 296107)
-- Name: title_genres_title; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX title_genres_title ON public.title_genres USING btree (title_id);


--
-- TOC entry 4837 (class 1259 OID 17484)
...
--
-- TOC entry 4857 (class 1259 OID 17485)
...
--
-- TOC entry 5005 (class 1259 OID 112028)
...
--
-- TOC entry 5008 (class 1259 OID 133168)
...
--
-- TOC entry 5077 (class 1259 OID 147859)
...
--
-- TOC entry 5080 (class 1259 OID 147871)
...
--
-- TOC entry 5093 (class 1259 OID 155048)
...
--
-- TOC entry 5110 (class 1259 OID 287369)
...
--
-- TOC entry 5122 (class 1259 OID 293914)
...
--
-- TOC entry 4840 (class 1259 OID 17386)
...
--
-- TOC entry 4851 (class 1259 OID 17367)
...
--
-- TOC entry 4841 (class 1259 OID 17241)
...
--
-- TOC entry 4749 (class 1259 OID 17287)
...
--
-- TOC entry 4750 (class 1259 OID 17206)
...
--
-- TOC entry 4751 (class 1259 OID 17291)
...
--
-- TOC entry 4846 (class 1259 OID 17292)
...
--
-- TOC entry 4752 (class 1259 OID 16583)
...
--
-- TOC entry 4753 (class 1259 OID 17290)
...
--
-- TOC entry 4854 (class 1259 OID 17358)
...
--
-- TOC entry 5236 (class 2620 OID 34731)
...
--
-- TOC entry 5249 (class 2620 OID 34970)
...
--
-- TOC entry 5247 (class 2620 OID 34917)
...
--
-- TOC entry 5251 (class 2620 OID 35017)
...
--
-- TOC entry 5250 (class 2620 OID 34991)
...
--
-- TOC entry 5259 (class 2620 OID 291585)
...
--
-- TOC entry 5245 (class 2620 OID 34732)
...
--
-- TOC entry 5246 (class 2620 OID 34892)
...
--
-- TOC entry 5248 (class 2620 OID 34944)
...
--
-- TOC entry 5252 (class 2620 OID 49087)
-- Name: messages sync_messages_user_and_sender_id_trg; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER sync_messages_user_and_sender_id_trg BEFORE INSERT OR UPDATE ON public.messages FOR EACH ROW EXECUTE FUNCTION public.sync_messages_user_and_sender_id();


--
-- TOC entry 5258 (class 2620 OID 285292)
...
--
-- TOC entry 5256 (class 2620 OID 152379)
...
--
-- TOC entry 5257 (class 2620 OID 153349)
-- Name: media_events trg_media_events_apply_feedback; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_media_events_apply_feedback AFTER INSERT ON public.media_events FOR EACH ROW EXECUTE FUNCTION public.apply_media_event_to_feedback_v1();


--
-- TOC entry 5253 (class 2620 OID 141659)
...
--
-- TOC entry 5254 (class 2620 OID 135425)
...
--
-- TOC entry 5255 (class 2620 OID 293493)
...
--
-- TOC entry 5242 (class 2620 OID 17152)
...
--
-- TOC entry 5237 (class 2620 OID 17299)
...
--
-- TOC entry 5238 (class 2620 OID 17329)
...
--
-- TOC entry 5239 (class 2620 OID 17283)
...
--
-- TOC entry 5240 (class 2620 OID 17328)
...
--
-- TOC entry 5243 (class 2620 OID 17295)
...
--
-- TOC entry 5244 (class 2620 OID 17330)
...
--
-- TOC entry 5241 (class 2620 OID 17191)
...
--
-- TOC entry 5158 (class 2606 OID 16734)
...
--
-- TOC entry 5163 (class 2606 OID 16823)
...
--
-- TOC entry 5162 (class 2606 OID 16811)
...
--
-- TOC entry 5161 (class 2606 OID 16798)
...
--
-- TOC entry 5169 (class 2606 OID 17063)
...
--
-- TOC entry 5170 (class 2606 OID 17068)
...
--
-- TOC entry 5171 (class 2606 OID 17092)
...
--
-- TOC entry 5172 (class 2606 OID 17087)
...
--
-- TOC entry 5168 (class 2606 OID 16989)
...
--
-- TOC entry 5156 (class 2606 OID 16767)
...
--
-- TOC entry 5165 (class 2606 OID 16870)
...
--
-- TOC entry 5166 (class 2606 OID 16943)
...
--
-- TOC entry 5159 (class 2606 OID 17106)
...
--
-- TOC entry 5160 (class 2606 OID 16762)
...
--
-- TOC entry 5164 (class 2606 OID 16851)
...
--
-- TOC entry 5193 (class 2606 OID 35110)
...
--
-- TOC entry 5194 (class 2606 OID 35105)
...
--
-- TOC entry 5215 (class 2606 OID 35409)
...
--
-- TOC entry 5216 (class 2606 OID 35404)
...
--
-- TOC entry 5191 (class 2606 OID 35086)
...
--
-- TOC entry 5192 (class 2606 OID 35091)
...
--
-- TOC entry 5182 (class 2606 OID 34965)
...
--
-- TOC entry 5183 (class 2606 OID 34960)
...
--
-- TOC entry 5184 (class 2606 OID 34955)
...
--
-- TOC entry 5197 (class 2606 OID 35163)
...
--
-- TOC entry 5198 (class 2606 OID 35168)
...
--
-- TOC entry 5196 (class 2606 OID 35147)
...
--
-- TOC entry 5187 (class 2606 OID 35052)
...
--
-- TOC entry 5188 (class 2606 OID 35047)
...
--
-- TOC entry 5180 (class 2606 OID 34904)
...
--
-- TOC entry 5186 (class 2606 OID 35005)
...
--
-- TOC entry 5185 (class 2606 OID 34984)
...
--
-- TOC entry 5221 (class 2606 OID 146843)
...
--
-- TOC entry 5222 (class 2606 OID 146887)
...
--
-- TOC entry 5223 (class 2606 OID 146882)
...
--
-- TOC entry 5224 (class 2606 OID 146908)
...
--
-- TOC entry 5225 (class 2606 OID 146903)
...
--
-- TOC entry 5230 (class 2606 OID 150320)
...
--
-- TOC entry 5231 (class 2606 OID 150332)
...
--
-- TOC entry 5227 (class 2606 OID 146935)
...
--
-- TOC entry 5228 (class 2606 OID 146946)
...
--
-- TOC entry 5226 (class 2606 OID 146922)
...
--
-- TOC entry 5205 (class 2606 OID 35235)
...
--
-- TOC entry 5206 (class 2606 OID 35240)
...
--
-- TOC entry 5207 (class 2606 OID 35245)
...
--
-- TOC entry 5202 (class 2606 OID 35208)
...
--
-- TOC entry 5203 (class 2606 OID 35213)
...
--
-- TOC entry 5204 (class 2606 OID 35218)
...
--
-- TOC entry 5208 (class 2606 OID 35259)
...
--
-- TOC entry 5209 (class 2606 OID 35269)
...
--
-- TOC entry 5210 (class 2606 OID 35264)
...
--
-- TOC entry 5199 (class 2606 OID 35187)
...
--
-- TOC entry 5200 (class 2606 OID 49081)
...
--
-- TOC entry 5201 (class 2606 OID 35192)
...
--
-- TOC entry 5234 (class 2606 OID 295863)
...
--
-- TOC entry 5235 (class 2606 OID 295858)
...
--
-- TOC entry 5220 (class 2606 OID 48659)
...
--
-- TOC entry 5195 (class 2606 OID 35128)
...
--
-- TOC entry 5178 (class 2606 OID 24617)
...
--
-- TOC entry 5179 (class 2606 OID 34879)
...
--
-- TOC entry 5218 (class 2606 OID 35442)
...
--
-- TOC entry 5219 (class 2606 OID 35447)
...
--
-- TOC entry 5189 (class 2606 OID 35066)
...
--
-- TOC entry 5190 (class 2606 OID 35071)
...
--
-- TOC entry 5181 (class 2606 OID 34930)
...
--
-- TOC entry 5232 (class 2606 OID 293485)
-- Name: title_genres title_genres_genre_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 5233 (class 2606 OID 293480)
-- Name: title_genres title_genres_title_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.title_genres
    ADD CONSTRAINT title_genres_title_id_fkey FOREIGN KEY (title_id) REFERENCES public.media_items(id) ON DELETE CASCADE;


--
-- TOC entry 5217 (class 2606 OID 35427)
...
--
-- TOC entry 5211 (class 2606 OID 35294)
...
--
-- TOC entry 5229 (class 2606 OID 146963)
...
--
-- TOC entry 5212 (class 2606 OID 35375)
...
--
-- TOC entry 5213 (class 2606 OID 35391)
...
--
-- TOC entry 5214 (class 2606 OID 35386)
...
--
-- TOC entry 5157 (class 2606 OID 16572)
...
--
-- TOC entry 5176 (class 2606 OID 17270)
...
--
-- TOC entry 5173 (class 2606 OID 17216)
...
--
-- TOC entry 5174 (class 2606 OID 17236)
...
--
-- TOC entry 5175 (class 2606 OID 17231)
...
--
-- TOC entry 5177 (class 2606 OID 17353)
...
--
-- TOC entry 5419 (class 0 OID 16525)
-- Dependencies: 363
...
--
-- TOC entry 5433 (class 0 OID 16929)
-- Dependencies: 380
...
--
-- TOC entry 5424 (class 0 OID 16727)
-- Dependencies: 371
...
--
-- TOC entry 5418 (class 0 OID 16518)
-- Dependencies: 362
...
--
-- TOC entry 5428 (class 0 OID 16816)
-- Dependencies: 375
...
--
-- TOC entry 5427 (class 0 OID 16804)
-- Dependencies: 374
...
--
-- TOC entry 5426 (class 0 OID 16791)
-- Dependencies: 373
...
--
-- TOC entry 5434 (class 0 OID 16979)
-- Dependencies: 381
...
--
-- TOC entry 5417 (class 0 OID 16507)
-- Dependencies: 361
...
--
-- TOC entry 5431 (class 0 OID 16858)
-- Dependencies: 378
...
--
-- TOC entry 5432 (class 0 OID 16876)
-- Dependencies: 379
...
--
-- TOC entry 5420 (class 0 OID 16533)
-- Dependencies: 364
...
--
-- TOC entry 5425 (class 0 OID 16757)
-- Dependencies: 372
...
--
-- TOC entry 5430 (class 0 OID 16843)
-- Dependencies: 377
...
--
-- TOC entry 5429 (class 0 OID 16834)
-- Dependencies: 376
...
--
-- TOC entry 5416 (class 0 OID 16495)
-- Dependencies: 359
...
--
-- TOC entry 5452 (class 0 OID 35098)
-- Dependencies: 410
...
--
-- TOC entry 5510 (class 3256 OID 53547)
-- Name: activity_events activity_events_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY activity_events_owner_only ON public.activity_events USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5484 (class 0 OID 287121)
-- Dependencies: 467
...
--
-- TOC entry 5486 (class 0 OID 287154)
-- Dependencies: 469
...
--
-- TOC entry 5507 (class 3256 OID 293816)
...
--
-- TOC entry 5483 (class 0 OID 287112)
-- Dependencies: 466
...
--
-- TOC entry 5465 (class 0 OID 35398)
-- Dependencies: 425
...
--
-- TOC entry 5515 (class 3256 OID 54546)
-- Name: blocked_users blocked_users_manage_self_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY blocked_users_manage_self_delete ON public.blocked_users FOR DELETE USING ((blocker_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5513 (class 3256 OID 54544)
-- Name: blocked_users blocked_users_manage_self_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY blocked_users_manage_self_insert ON public.blocked_users FOR INSERT WITH CHECK ((blocker_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5514 (class 3256 OID 54545)
-- Name: blocked_users blocked_users_manage_self_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY blocked_users_manage_self_update ON public.blocked_users FOR UPDATE USING ((blocker_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((blocker_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5516 (class 3256 OID 54547)
-- Name: blocked_users blocked_users_view_related; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY blocked_users_view_related ON public.blocked_users FOR SELECT USING (((( SELECT auth.uid() AS uid) = blocker_id) OR (( SELECT auth.uid() AS uid) = blocked_id)));


--
-- TOC entry 5451 (class 0 OID 35080)
-- Dependencies: 409
...
--
-- TOC entry 5523 (class 3256 OID 54550)
-- Name: comment_likes comment_likes_owner_only_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY comment_likes_owner_only_delete ON public.comment_likes FOR DELETE USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5517 (class 3256 OID 54548)
-- Name: comment_likes comment_likes_owner_only_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY comment_likes_owner_only_insert ON public.comment_likes FOR INSERT WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5519 (class 3256 OID 54549)
-- Name: comment_likes comment_likes_owner_only_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY comment_likes_owner_only_update ON public.comment_likes FOR UPDATE USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5502 (class 3256 OID 54469)
...
--
-- TOC entry 5446 (class 0 OID 34945)
-- Dependencies: 404
...
--
-- TOC entry 5582 (class 3256 OID 53577)
-- Name: comments comments_insert_self; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY comments_insert_self ON public.comments FOR INSERT WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5522 (class 3256 OID 53579)
-- Name: comments comments_owner_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY comments_owner_delete ON public.comments FOR DELETE USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5524 (class 3256 OID 53578)
-- Name: comments comments_owner_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY comments_owner_update ON public.comments FOR UPDATE USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5581 (class 3256 OID 53576)
...
--
-- TOC entry 5455 (class 0 OID 35154)
-- Dependencies: 413
...
--
-- TOC entry 5531 (class 3256 OID 53555)
-- Name: conversation_participants conversation_participants_self; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY conversation_participants_self ON public.conversation_participants USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5454 (class 0 OID 35138)
-- Dependencies: 412
...
--
-- TOC entry 5518 (class 3256 OID 54551)
...
--
-- TOC entry 5549 (class 3256 OID 134554)
-- Name: message_delivery_receipts delivery_receipts_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY delivery_receipts_insert_own ON public.message_delivery_receipts FOR INSERT TO authenticated WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5551 (class 3256 OID 134596)
...
CREATE POLICY delivery_receipts_select_participants ON public.message_delivery_receipts FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
  ...
  WHERE ((m.id = message_delivery_receipts.message_id) AND (cp.user_id = ( SELECT auth.uid() AS uid))))));


--
-- TOC entry 5579 (class 3256 OID 287151)
...
--
-- TOC entry 5578 (class 3256 OID 287150)
...
--
-- TOC entry 5580 (class 3256 OID 287152)
...
--
-- TOC entry 5482 (class 0 OID 285049)
-- Dependencies: 461
...
--
-- TOC entry 5577 (class 3256 OID 286622)
-- Name: embedding_settings embedding_settings_deny_all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY embedding_settings_deny_all ON public.embedding_settings AS RESTRICTIVE USING (false) WITH CHECK (false);


--
-- TOC entry 5449 (class 0 OID 35041)
-- Dependencies: 407
...
--
-- TOC entry 5527 (class 3256 OID 54555)
-- Name: follows follows_manage_own_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follows_manage_own_delete ON public.follows FOR DELETE USING ((follower_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5525 (class 3256 OID 54553)
-- Name: follows follows_manage_own_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follows_manage_own_insert ON public.follows FOR INSERT WITH CHECK ((follower_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5526 (class 3256 OID 54554)
-- Name: follows follows_manage_own_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follows_manage_own_update ON public.follows FOR UPDATE USING ((follower_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((follower_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5528 (class 3256 OID 54556)
-- Name: follows follows_self_visibility; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follows_self_visibility ON public.follows FOR SELECT USING (((( SELECT auth.uid() AS uid) = follower_id) OR (( SELECT auth.uid() AS uid) = followed_id)));


--
-- TOC entry 5461 (class 0 OID 35300)
-- Dependencies: 420
...
--
-- TOC entry 5520 (class 3256 OID 35482)
...
--
-- TOC entry 5485 (class 0 OID 287132)
-- Dependencies: 468
...
--
-- TOC entry 5444 (class 0 OID 34893)
-- Dependencies: 402
...
--
-- TOC entry 5529 (class 3256 OID 54557)
-- Name: library_entries library_entries_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY library_entries_owner_only ON public.library_entries USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5448 (class 0 OID 34994)
-- Dependencies: 406
...
--
-- TOC entry 5539 (class 3256 OID 54625)
...
CREATE POLICY list_items_owner_only ON public.list_items USING ((EXISTS ( SELECT 1
   FROM public.lists l
  WHERE ((l.id = list_items.list_id) AND (l.user_id = ( SELECT auth.uid() AS uid)))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.lists l
  WHERE ((l.id = list_items.list_id) AND (l.user_id = ( SELECT auth.uid() AS uid))))));


--
-- TOC entry 5447 (class 0 OID 34973)
-- Dependencies: 405
...
--
-- TOC entry 5538 (class 3256 OID 54624)
-- Name: lists lists_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY lists_owner_only ON public.lists USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5472 (class 0 OID 146833)
-- Dependencies: 447
...
--
-- TOC entry 5566 (class 3256 OID 153444)
...
--
-- TOC entry 5473 (class 0 OID 146873)
-- Dependencies: 448
...
--
-- TOC entry 5568 (class 3256 OID 153446)
-- Name: media_events media_events_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_events_insert_own ON public.media_events FOR INSERT TO authenticated WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5569 (class 3256 OID 153447)
-- Name: media_events media_events_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_events_select_own ON public.media_events FOR SELECT TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5474 (class 0 OID 146895)
-- Dependencies: 449
...
--
-- TOC entry 5571 (class 3256 OID 153449)
-- Name: media_feedback media_feedback_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_feedback_insert_own ON public.media_feedback FOR INSERT TO authenticated WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5570 (class 3256 OID 153448)
-- Name: media_feedback media_feedback_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_feedback_select_own ON public.media_feedback FOR SELECT TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5572 (class 3256 OID 153450)
-- Name: media_feedback media_feedback_update_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_feedback_update_own ON public.media_feedback FOR UPDATE TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5479 (class 0 OID 150305)
-- Dependencies: 456
...
--
-- TOC entry 5564 (class 3256 OID 153442)
...
--
-- TOC entry 5480 (class 0 OID 150327)
-- Dependencies: 457
...
--
-- TOC entry 5565 (class 3256 OID 153443)
...
--
-- TOC entry 5469 (class 0 OID 135411)
-- Dependencies: 443
...
--
-- TOC entry 5559 (class 3256 OID 137678)
...
--
-- TOC entry 5481 (class 0 OID 154206)
-- Dependencies: 459
...
--
-- TOC entry 5576 (class 3256 OID 154727)
...
--
-- TOC entry 5491 (class 0 OID 295881)
-- Dependencies: 476
...
--
-- TOC entry 5532 (class 3256 OID 340407)
-- Name: media_rank_feature_log media_rank_feature_log_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_rank_feature_log_insert_own ON public.media_rank_feature_log FOR INSERT TO authenticated WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5509 (class 3256 OID 340406)
-- Name: media_rank_feature_log media_rank_feature_log_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_rank_feature_log_select_own ON public.media_rank_feature_log FOR SELECT TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5497 (class 3256 OID 340264)
...
--
-- TOC entry 5490 (class 0 OID 295869)
-- Dependencies: 475
...
--
-- TOC entry 5500 (class 3256 OID 340267)
...
--
-- TOC entry 5487 (class 0 OID 291572)
-- Dependencies: 471
...
--
-- TOC entry 5542 (class 3256 OID 293861)
-- Name: media_rerank_cache media_rerank_cache_delete_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_rerank_cache_delete_own ON public.media_rerank_cache FOR DELETE TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5512 (class 3256 OID 293859)
-- Name: media_rerank_cache media_rerank_cache_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_rerank_cache_insert_own ON public.media_rerank_cache FOR INSERT TO authenticated WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5511 (class 3256 OID 293858)
-- Name: media_rerank_cache media_rerank_cache_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_rerank_cache_select_own ON public.media_rerank_cache FOR SELECT TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5541 (class 3256 OID 293860)
-- Name: media_rerank_cache media_rerank_cache_update_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_rerank_cache_update_own ON public.media_rerank_cache FOR UPDATE TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5492 (class 0 OID 325903)
-- Dependencies: 477
...
--
-- TOC entry 5508 (class 3256 OID 340405)
-- Name: media_served media_served_delete_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_served_delete_own ON public.media_served FOR DELETE TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5504 (class 3256 OID 340403)
-- Name: media_served media_served_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_served_insert_own ON public.media_served FOR INSERT TO authenticated WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5503 (class 3256 OID 340402)
-- Name: media_served media_served_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_served_select_own ON public.media_served FOR SELECT TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5496 (class 3256 OID 340261)
...
--
-- TOC entry 5506 (class 3256 OID 340404)
-- Name: media_served media_served_update_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_served_update_own ON public.media_served FOR UPDATE TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5476 (class 0 OID 146927)
-- Dependencies: 451
...
--
-- TOC entry 5574 (class 3256 OID 153452)
-- Name: media_session_vectors media_session_vectors_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_session_vectors_own ON public.media_session_vectors TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5477 (class 0 OID 146940)
-- Dependencies: 452
...
--
-- TOC entry 5567 (class 3256 OID 153445)
...
--
-- TOC entry 5489 (class 0 OID 295826)
-- Dependencies: 474
...
--
-- TOC entry 5535 (class 3256 OID 340408)
-- Name: media_user_centroids media_user_centroids_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_user_centroids_select_own ON public.media_user_centroids FOR SELECT TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5498 (class 3256 OID 340266)
...
--
-- TOC entry 5475 (class 0 OID 146914)
-- Dependencies: 450
...
--
-- TOC entry 5573 (class 3256 OID 153451)
-- Name: media_user_vectors media_user_vectors_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY media_user_vectors_own ON public.media_user_vectors TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5458 (class 0 OID 35227)
-- Dependencies: 416
...
--
-- TOC entry 5457 (class 0 OID 35201)
-- Dependencies: 415
...
--
-- TOC entry 5546 (class 3256 OID 53567)
-- Name: message_reactions message_reactions_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY message_reactions_delete ON public.message_reactions FOR DELETE USING (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = cp.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid)))))));


--
-- TOC entry 5547 (class 3256 OID 53565)
-- Name: message_reactions message_reactions_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY message_reactions_owner_only ON public.message_reactions FOR UPDATE USING (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = cp.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid))))))) WITH CHECK (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = cp.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid)))))));


--
-- TOC entry 5548 (class 3256 OID 53563)
...
--
-- TOC entry 5550 (class 3256 OID 53564)
-- Name: message_reactions message_reactions_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY message_reactions_write ON public.message_reactions FOR INSERT TO authenticated WITH CHECK (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = cp.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid)))))));


--
-- TOC entry 5459 (class 0 OID 35253)
-- Dependencies: 417
...
--
-- TOC entry 5456 (class 0 OID 35180)
-- Dependencies: 414
...
--
-- TOC entry 5536 (class 3256 OID 54562)
...
--
-- TOC entry 5534 (class 3256 OID 54561)
-- Name: messages messages_member_write_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY messages_member_write_delete ON public.messages FOR DELETE USING (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = messages.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid)))))));


--
-- TOC entry 5530 (class 3256 OID 54558)
-- Name: messages messages_member_write_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY messages_member_write_insert ON public.messages FOR INSERT WITH CHECK (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = messages.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid)))))));


--
-- TOC entry 5533 (class 3256 OID 54559)
-- Name: messages messages_member_write_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY messages_member_write_update ON public.messages FOR UPDATE USING (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = messages.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid))))))) WITH CHECK (((user_id = ( SELECT auth.uid() AS uid)) AND (EXISTS ( SELECT 1
   FROM public.conversation_participants cp
  WHERE ((cp.conversation_id = messages.conversation_id) AND (cp.user_id = ( SELECT auth.uid() AS uid)))))));


--
-- TOC entry 5468 (class 0 OID 48649)
-- Dependencies: 428
...
--
-- TOC entry 5552 (class 3256 OID 53569)
-- Name: notification_preferences notification_preferences_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY notification_preferences_owner_only ON public.notification_preferences USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5453 (class 0 OID 35120)
-- Dependencies: 411
...
--
-- TOC entry 5553 (class 3256 OID 53568)
-- Name: notifications notifications_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY notifications_owner_only ON public.notifications USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5471 (class 0 OID 137055)
-- Dependencies: 445
...
--
-- TOC entry 5560 (class 3256 OID 137679)
...
--
-- TOC entry 5462 (class 0 OID 35323)
-- Dependencies: 422
...
--
-- TOC entry 5521 (class 3256 OID 35484)
...
--
-- TOC entry 5442 (class 0 OID 24610)
-- Dependencies: 400
...
--
-- TOC entry 5554 (class 3256 OID 53540)
-- Name: profiles profiles_insert_self; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY profiles_insert_self ON public.profiles FOR INSERT WITH CHECK ((id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5543 (class 3256 OID 59996)
-- Name: profiles profiles_select_authenticated_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY profiles_select_authenticated_only ON public.profiles FOR SELECT TO authenticated USING (true);


--
-- TOC entry 5555 (class 3256 OID 53541)
-- Name: profiles profiles_update_self; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY profiles_update_self ON public.profiles FOR UPDATE USING ((id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5443 (class 0 OID 34868)
-- Dependencies: 401
...
--
-- TOC entry 5537 (class 3256 OID 54563)
-- Name: ratings ratings_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ratings_owner_only ON public.ratings USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5584 (class 3256 OID 293082)
...
--
-- TOC entry 5556 (class 3256 OID 135052)
-- Name: message_read_receipts read_receipts_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY read_receipts_insert_own ON public.message_read_receipts FOR INSERT TO authenticated WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5558 (class 3256 OID 135054)
...
--
-- TOC entry 5557 (class 3256 OID 135053)
-- Name: message_read_receipts read_receipts_update_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY read_receipts_update_own ON public.message_read_receipts FOR UPDATE TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5467 (class 0 OID 35432)
-- Dependencies: 427
...
--
-- TOC entry 5562 (class 3256 OID 53570)
-- Name: reports reports_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY reports_owner_only ON public.reports USING ((reporter_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((reporter_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5450 (class 0 OID 35059)
-- Dependencies: 408
...
--
-- TOC entry 5563 (class 3256 OID 53544)
-- Name: review_reactions review_reactions_participant_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY review_reactions_participant_only ON public.review_reactions USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5445 (class 0 OID 34918)
-- Dependencies: 403
...
--
-- TOC entry 5501 (class 3256 OID 53543)
-- Name: reviews reviews_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY reviews_owner_only ON public.reviews USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5488 (class 0 OID 293474)
-- Dependencies: 472
-- Name: title_genres; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.title_genres ENABLE ROW LEVEL SECURITY;

--
-- TOC entry 5499 (class 3256 OID 293690)
-- Name: title_genres title_genres_read_all_authenticated; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY title_genres_read_all_authenticated ON public.title_genres FOR SELECT TO authenticated USING (true);


--
-- TOC entry 5470 (class 0 OID 136524)
-- Dependencies: 444
...
--
-- TOC entry 5561 (class 3256 OID 137680)
...
--
-- TOC entry 5466 (class 0 OID 35416)
-- Dependencies: 426
...
--
-- TOC entry 5505 (class 3256 OID 53571)
-- Name: user_settings user_settings_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_settings_owner_only ON public.user_settings USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5460 (class 0 OID 35281)
-- Dependencies: 418
...
--
-- TOC entry 5540 (class 3256 OID 54627)
-- Name: user_stats user_stats_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_stats_owner_only ON public.user_stats USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5478 (class 0 OID 146951)
-- Dependencies: 453
...
--
-- TOC entry 5575 (class 3256 OID 153453)
-- Name: user_swipe_prefs user_swipe_prefs_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_swipe_prefs_own ON public.user_swipe_prefs TO authenticated USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5463 (class 0 OID 35364)
-- Dependencies: 423
...
--
-- TOC entry 5583 (class 3256 OID 53572)
-- Name: user_tags user_tags_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_tags_owner_only ON public.user_tags USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5464 (class 0 OID 35380)
-- Dependencies: 424
...
--
-- TOC entry 5585 (class 3256 OID 53573)
-- Name: user_title_tags user_title_tags_owner_only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_title_tags_owner_only ON public.user_title_tags USING ((user_id = ( SELECT auth.uid() AS uid))) WITH CHECK ((user_id = ( SELECT auth.uid() AS uid)));


--
-- TOC entry 5441 (class 0 OID 17469)
-- Dependencies: 397
...
--
-- TOC entry 5545 (class 3256 OID 130116)
...
--
-- TOC entry 5544 (class 3256 OID 130054)
...
--
-- TOC entry 5493 (class 3256 OID 25518)
...
--
-- TOC entry 5495 (class 3256 OID 25520)
-- Name: objects Public update avatars; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Public update avatars" ON storage.objects FOR UPDATE USING ((bucket_id = 'avatars'::text)) WITH CHECK ((bucket_id = 'avatars'::text));


--
-- TOC entry 5494 (class 3256 OID 25519)
-- Name: objects Public upload avatars; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Public upload avatars" ON storage.objects FOR INSERT WITH CHECK ((bucket_id = 'avatars'::text));


--
-- TOC entry 5421 (class 0 OID 16546)
-- Dependencies: 365
...
--
-- TOC entry 5438 (class 0 OID 17306)
-- Dependencies: 393
...
--
-- TOC entry 5439 (class 0 OID 17333)
-- Dependencies: 394
...
--
-- TOC entry 5423 (class 0 OID 16588)
-- Dependencies: 367
...
--
-- TOC entry 5422 (class 0 OID 16561)
-- Dependencies: 366
...
--
-- TOC entry 5437 (class 0 OID 17260)
-- Dependencies: 392
...
--
-- TOC entry 5435 (class 0 OID 17207)
-- Dependencies: 390
...
--
-- TOC entry 5436 (class 0 OID 17221)
-- Dependencies: 391
...
--
-- TOC entry 5440 (class 0 OID 17343)
-- Dependencies: 395
...
--
-- TOC entry 5587 (class 6104 OID 16426)
...
--
-- TOC entry 5586 (class 6104 OID 19360)
...
--
-- TOC entry 5592 (class 6106 OID 52027)
...
--
-- TOC entry 5593 (class 6106 OID 52028)
...
--
-- TOC entry 5588 (class 6106 OID 52023)
...
--
-- TOC entry 5589 (class 6106 OID 52024)
...
--
-- TOC entry 5590 (class 6106 OID 52025)
...
--
-- TOC entry 5591 (class 6106 OID 52026)
...
--
-- TOC entry 5594 (class 6106 OID 25927)
...
GRANT ALL ON FUNCTION public.admin_search_users(p_search text, p_limit integer, p_offset integer) TO anon;
...
-- Dependencies: 577
-- Name: FUNCTION apply_media_event_to_feedback_v1(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.apply_media_event_to_feedback_v1() TO anon;
GRANT ALL ON FUNCTION public.apply_media_event_to_feedback_v1() TO authenticated;
GRANT ALL ON FUNCTION public.apply_media_event_to_feedback_v1() TO service_role;
...
GRANT ALL ON FUNCTION public.get_home_feed(p_user_id uuid, p_limit integer, p_cursor timestamp with time zone) TO anon;
...
-- Dependencies: 661
-- Name: FUNCTION invoke_media_embed_backfill_openai_edge_with_anon_key(batch_size integer, reembed boolean, kind text, openai_model text, openai_dimensions integer, task text, use_saved_cursor boolean); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.invoke_media_embed_backfill_openai_edge_with_anon_key(batch_size integer, reembed boolean, kind text, openai_model text, openai_dimensions integer, task text, use_saved_cursor boolean) TO anon;
GRANT ALL ON FUNCTION public.invoke_media_embed_backfill_openai_edge_with_anon_key(batch_size integer, reembed boolean, kind text, openai_model text, openai_dimensions integer, task text, use_saved_cursor boolean) TO authenticated;
GRANT ALL ON FUNCTION public.invoke_media_embed_backfill_openai_edge_with_anon_key(batch_size integer, reembed boolean, kind text, openai_model text, openai_dimensions integer, task text, use_saved_cursor boolean) TO service_role;
...
-- Dependencies: 750
-- Name: FUNCTION media_update_taste_vectors_v1(p_session_id uuid, p_media_item_id uuid, p_event_type text, p_dwell_ms integer, p_rating_0_10 numeric, p_in_watchlist boolean); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.media_update_taste_vectors_v1(p_session_id uuid, p_media_item_id uuid, p_event_type text, p_dwell_ms integer, p_rating_0_10 numeric, p_in_watchlist boolean) TO anon;
GRANT ALL ON FUNCTION public.media_update_taste_vectors_v1(p_session_id uuid, p_media_item_id uuid, p_event_type text, p_dwell_ms integer, p_rating_0_10 numeric, p_in_watchlist boolean) TO authenticated;
GRANT ALL ON FUNCTION public.media_update_taste_vectors_v1(p_session_id uuid, p_media_item_id uuid, p_event_type text, p_dwell_ms integer, p_rating_0_10 numeric, p_in_watchlist boolean) TO service_role;
...
-- Dependencies: 597
-- Name: FUNCTION sync_messages_user_and_sender_id(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.sync_messages_user_and_sender_id() TO anon;
GRANT ALL ON FUNCTION public.sync_messages_user_and_sender_id() TO authenticated;
GRANT ALL ON FUNCTION public.sync_messages_user_and_sender_id() TO service_role;
...
-- Dependencies: 684
-- Name: FUNCTION titles_tsvector_trigger(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.titles_tsvector_trigger() TO anon;
GRANT ALL ON FUNCTION public.titles_tsvector_trigger() TO authenticated;
GRANT ALL ON FUNCTION public.titles_tsvector_trigger() TO service_role;
...
-- Dependencies: 472
-- Name: TABLE title_genres; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.title_genres TO anon;
GRANT ALL ON TABLE public.title_genres TO authenticated;
GRANT ALL ON TABLE public.title_genres TO service_role;
...
--
-- TOC entry 3178 (class 826 OID 16603)
...
--
-- TOC entry 3179 (class 826 OID 16604)
...
--
-- TOC entry 3177 (class 826 OID 16602)
...
--
-- TOC entry 3192 (class 826 OID 56916)
...
--
-- TOC entry 3194 (class 826 OID 56915)
...
--
-- TOC entry 3193 (class 826 OID 56914)
...
--
-- TOC entry 3188 (class 826 OID 16682)
...
--
-- TOC entry 3187 (class 826 OID 16681)
...
--
-- TOC entry 3186 (class 826 OID 16680)
...
--
-- TOC entry 3191 (class 826 OID 16637)
...
--
-- TOC entry 3190 (class 826 OID 16636)
...
--
-- TOC entry 3189 (class 826 OID 16635)
...
--
-- TOC entry 3183 (class 826 OID 16617)
...
--
-- TOC entry 3185 (class 826 OID 16616)
...
--
-- TOC entry 3184 (class 826 OID 16615)
...
--
-- TOC entry 3170 (class 826 OID 16490)
...
--
-- TOC entry 3171 (class 826 OID 16491)
...
--
-- TOC entry 3169 (class 826 OID 16489)
...
--
-- TOC entry 3173 (class 826 OID 16493)
...
--
-- TOC entry 3168 (class 826 OID 16488)
...
--
-- TOC entry 3172 (class 826 OID 16492)
...
--
-- TOC entry 3181 (class 826 OID 16607)
...
--
-- TOC entry 3182 (class 826 OID 16608)
...
--
-- TOC entry 3180 (class 826 OID 16606)
...
--
-- TOC entry 3176 (class 826 OID 16545)
...
--
-- TOC entry 3175 (class 826 OID 16544)
...
--
-- TOC entry 3174 (class 826 OID 16543)
...
--
-- TOC entry 4385 (class 3466 OID 16621)
...
--
-- TOC entry 4390 (class 3466 OID 16700)
...
--
-- TOC entry 4384 (class 3466 OID 16619)
...
--
-- TOC entry 4391 (class 3466 OID 16703)
...
--
-- TOC entry 4386 (class 3466 OID 16622)
...
--
-- TOC entry 4387 (class 3466 OID 16623)
...
-- Completed on 2025-12-20 14:34:45

--
-- PostgreSQL database dump complete
--

\unrestrict i5UCautRzRyXLQ88GlpmvVeaadpbUqtr23GGLQE5rYuSXAiKYafDaTZ8xgsBKiq
