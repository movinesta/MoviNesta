-- MoviNesta Supabase ONE-RUN migration bundle
-- Generated: 2026-01-08
--
-- How to use:
-- 1) Ensure your database is already created (e.g., via schema_full_20260107_041102.sql).
-- 2) Paste this entire file into the Supabase SQL Editor and run.
--
-- This bundle concatenates the SQL in supabase/migrations in chronological order.
