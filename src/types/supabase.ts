  ...
  public: {
    Tables: {
      ...
      rec_impressions: {
        ...
        Relationships: [
          {
            foreignKeyName: "rec_impressions_user_fk";
            columns: ["user_id"];
            referencedRelation: "users";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "rec_impressions_media_item_fk";
      ...
      rec_outcomes: {
        ...
        Relationships: [
          {
            foreignKeyName: "rec_outcomes_user_fk";
            columns: ["user_id"];
            referencedRelation: "users";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "rec_outcomes_media_item_fk";
            columns: ["media_item_id"];
            referencedRelation: "media_items";
            referencedColumns: ["id"];
          }
    ...
    Functions: {
      ...
      sync_profiles_public_from_verification: {
        Args: Record<string, never>;
        Returns: unknown;
      };
