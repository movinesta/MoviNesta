...
export type MainTabKey = "home" | "swipe" | "messages" | "search" | "profile";
  ...
  persist(
    ...
    }),
    {
      ...
      migrate: (persistedState) => {
        ...
        if (next.lastVisitedTab === "diary") next.lastVisitedTab = "profile";
        if (next.startTab === "diary") next.startTab = "profile";
