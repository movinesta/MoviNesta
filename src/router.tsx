...
const VerificationHelpPage = lazyWithRetry(() => import("./modules/help/VerificationHelpPage"));
...
const AssistantChatPage = lazyWithRetry(() => import("./modules/assistant/AssistantChatPage"));
      ...
      <Routes>
        ...
        <Route element={<RequireAuth />}>
          ...
          <Route element={<AppShell />}>
            ...
            <Route path="/help/verification" element={<VerificationHelpPage />} />
          </Route>
        </Route>
