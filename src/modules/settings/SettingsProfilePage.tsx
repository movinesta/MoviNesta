  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div className="mb-2 flex items-start gap-3">
        <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-border/50">
          ...
          <div className="mt-4">
            <VerificationPanel
              ...
              profile={{
                ...
                verifiedType: (profile as any).verifiedType ?? null,
                verifiedLabel: (profile as any).verifiedLabel ?? null,
                verifiedAt: (profile as any).verifiedAt ?? null,
                verifiedByOrg: (profile as any).verifiedByOrg ?? null,
              }}
            />
          </div>
        </PageSection>
