      ...
      <div className="space-y-3 px-3 py-4">
        {people.map((person) => {
          ...
          return (
            <div
              key={person.id}
              className="relative overflow-hidden rounded-2xl border border-border bg-card/80 p-3 shadow-lg"
            >
              <button
                type="button"
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={
                      person.isFollowing
                        ? "h-8 rounded-full bg-muted px-3 text-xs text-foreground hover:bg-muted/80"
                    ...
                    <DropdownMenuContent align="end" className="w-44">
                      <DropdownMenuItem
                        onClick={() => {
                          ...
                          copyToClipboard(`${window.location.origin}/u/${person.username}`);
                        }}
