  ...
  return (
    <div className="space-y-3 px-2 pb-4">
      ...
      <section className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        <div className="rounded-mn-card border border-mn-border-subtle/60 bg-mn-bg-elevated/80 p-3 shadow-mn-card">
        ...
        <div className="col-span-2 rounded-mn-card border border-mn-border-subtle/60 bg-mn-bg-elevated/80 p-3 text-[11px] text-mn-text-secondary shadow-mn-card sm:col-span-1">
          <div className="flex items-center justify-between gap-2">
            <span className="text-[11px] text-mn-text-secondary">Average rating</span>
            <PieChart className="h-3.5 w-3.5 text-mn-text-muted" aria-hidden="true" />
          </div>
      ...
      {/* Rating distribution */}
      <section className="rounded-mn-card border border-mn-border-subtle/60 bg-mn-bg-elevated/80 p-3 shadow-mn-card">
        <div className="mb-2 flex items-center justify-between gap-2">
          <h2 className="text-xs font-semibold text-mn-text-primary">Rating distribution</h2>
              ...
              return (
                <div key={bucket.rating} className="flex flex-1 flex-col items-center gap-1">
                  <div
                    ...
                    aria-hidden="true"
                  />
                  <span className="text-[9px] text-mn-text-secondary">
      ...
      <section className="rounded-mn-card border border-mn-border-subtle/60 bg-mn-bg-elevated/80 p-3 shadow-mn-card">
        <div className="mb-2 flex items-center justify-between gap-2">
          <h2 className="text-xs font-semibold text-mn-text-primary">Top genres</h2>
          <span className="text-[10px] text-mn-text-muted">
        ...
        {!topGenres.length ? (
          ...
          <div className="flex flex-wrap gap-1.5">
            {topGenres.map((genre) => (
              <span
                key={genre.genre}
                className="inline-flex items-center gap-1 rounded-full bg-mn-primary-soft/15 px-2.5 py-1 text-[10px] text-mn-text-primary"
              >
                <span className="h-1.5 w-1.5 rounded-full bg-mn-primary" aria-hidden="true" />
                <span className="font-medium">{genre.genre}</span>
                <span className="text-[9px] text-mn-text-muted">×{genre.count}</span>
              </span>
            ))}
          </div>
        )}
      ...
      <section className="rounded-mn-card border border-mn-border-subtle/60 bg-mn-bg-elevated/80 p-3 shadow-mn-card">
        <div className="mb-2 flex items-center justify-between gap-2">
          <h2 className="text-xs font-semibold text-mn-text-primary">Watch count over time</h2>
          <span className="text-[10px] text-mn-text-muted">
