      ...
      <div className="px-2 pb-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {Array.from({ length: 6 }).map((_, idx) => (
            <div
              key={idx}
              className="overflow-hidden rounded-2xl border border-border bg-card/80 shadow-lg"
            >
        ...
        {entries.length === 0 ? (
          ...
          entries.map((entry) => {
            ...
            return (
              <article
                key={entry.id}
                className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card/80 shadow-lg"
              >
