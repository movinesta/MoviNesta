...
const SwipePage: React.FC = () => {
  ...
  const finishDrag = () => {
    ...
    if (isTap && !isDetailDrag && !tapStartedOnInteractiveRef.current) {
      setIsDetailMode((v) => !v);
      setIsFullDetailOpen(false);
      setShowFullFriendReview(false);
      resetCardPosition();
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-6rem)] min-h-[calc(100dvh-6rem)] flex-1 flex-col overflow-hidden pb-[calc(6.5rem+env(safe-area-inset-bottom))]">
      ...
      <div className="relative z-10 mt-2 flex flex-1 flex-col overflow-visible px-4">
          ...
          {!isLoading && activeCard && (
            <>
              {/* active card */}
	               ...
	               */}
	              <div className="relative z-10 mx-auto h-[74vh] h-[74dvh] max-h-[720px] w-full max-w-md">
                ...
                <div className="relative h-full w-full rounded-[44px] bg-gradient-to-b from-white/10 via-primary/25 to-white/10 p-[1.25px] shadow-[0_30px_90px_rgba(0,0,0,0.75)]">
                  ...
                  >
                    ...
                    {isDetailMode && activeCard && (
                      // Render as an absolute overlay so it never affects the card's layout height.
		...
		<div className="mt-3 flex items-center justify-center gap-9 sm:mt-4 sm:gap-10" aria-label="Swipe actions">
          <button
            type="button"
