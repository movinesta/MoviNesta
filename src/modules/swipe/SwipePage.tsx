...
export const LoadingSwipeCard: React.FC = () => {
  ...
  return (
    <article
      className="relative z-[9999] mx-auto flex h-[72%] max-h-[480px] w-full max-w-md select-none flex-col overflow-hidden rounded-[30px] border border-mn-border-subtle/70 bg-gradient-to-br from-mn-bg-elevated/95 via-mn-bg/95 to-mn-bg-elevated/90 shadow-mn-card backdrop-blur transition-transform transition-shadow duration-300 hover:-translate-y-3 hover:scale-[1.03] hover:shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
      style={{
