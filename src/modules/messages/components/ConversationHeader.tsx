            ...
            {isLoading ? (
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  {!isGroupConversation && otherParticipant?.isVerified ? (
                    <VerifiedBadge
                      isVerified={otherParticipant?.isVerified ?? null}
                      type={(otherParticipant.verifiedType as any) ?? null}
                      label={otherParticipant.verifiedLabel ?? null}
                      verifiedAt={otherParticipant.verifiedAt ?? null}
                      org={otherParticipant.verifiedByOrg ?? null}
                    />
                  ) : null}
                  {isGroupConversation && (
