        ...
        <div className="relative h-full w-full">
          <div className="absolute left-0 top-0 z-10 flex w-full items-center justify-between gap-2 p-3">
            ...
            <div className="inline-flex items-center gap-2">
              ...
              <div className="inline-flex items-center gap-1 rounded-full bg-black/40 p-1.5 text-white">
                <button
                  type="button"
                  className="icon-hit-dark"
              ...
              <button
                type="button"
                className="icon-hit-dark bg-black/40 hover:bg-black/55"
