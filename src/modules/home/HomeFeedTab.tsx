...
import { BookmarkPlus, CheckCircle2, MessageSquare, Sparkles, Star } from "lucide-react";
...
const filterMatchesItem = (
  ...
  const matchesFeedFilter = (() => {
    switch (filter) {
      ...
      case "watchlist":
        return item.kind === "watchlist-add" || item.kind === "watchlist-remove";
      case "watched":
        return item.kind === "friend-watched";
