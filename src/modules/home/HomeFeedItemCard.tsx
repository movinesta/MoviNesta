...
import { BookmarkMinus, BookmarkPlus, CheckCircle2, Sparkles, Star } from "lucide-react";
...
const StatPill: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <Chip className="gap-1 px-2 py-0.5 text-xs shadow-sm">{children}</Chip>
);
...
const CardShell: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="rounded-2xl border border-border/50 bg-card/60 card-pad shadow-sm backdrop-blur">
